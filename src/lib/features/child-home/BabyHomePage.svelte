...
>
	...
	<Card>
		<div class="flex flex-col gap-3 py-2">
			...
			<a
				...
				class="tap-target inline-flex items-center justify-center font-bold transition-all bg-[var(--theme-primary)] text-white hover:brightness-90 active:brightness-80 px-6 py-3 text-base rounded-[var(--radius-md)] min-h-12"
	...
	<div class="flex justify-center pt-2">
		<a
			href="/admin"
			class="tap-target inline-flex items-center justify-center font-bold transition-all bg-transparent text-[var(--color-text-muted)] hover:bg-black/5 active:bg-black/10 px-4 py-2 text-sm rounded-[var(--radius-sm)]"

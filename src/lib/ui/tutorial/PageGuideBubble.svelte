...
-->
<!-- data-has-target (#4677): selector を持つ step か。E2E が「selector step は必ず実要素に spotlight する」を
  機械検証するための属性 (EPIC #4650 判断 4)。 -->
<div class="guide-bubble" data-step-id={step.id} data-has-target={step.selector ? 'true' : 'false'}>
	<!-- Header -->

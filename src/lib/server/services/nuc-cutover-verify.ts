// src/lib/server/services/nuc-cutover-verify.ts
...
import type { SqlExecutor } from '$lib/server/db/dsql/sql-executor';
...
export const CUTOVER_COUNT_AXES = [
	...
	{ key: 'loginBonuses', table: 'login_bonuses' },
...
export function summarizeExportCounts(data: ExportData): CutoverCounts {
	...
	return {
		...
		loginBonuses: tx.loginBonuses.length,

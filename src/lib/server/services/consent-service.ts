...
// #4497: あわせて §3 施行規則 17 条 2 項 / §7 Cookie / §10 越境移転を改定している。
//
//   PO 決裁 A (#4516 2026-08-20 コメント) により #4516/#4598/#4778 の 3 PR で
//   2026-08-20 に同値化済み。3 本は同一リリースで cut する。
// #4944: 第 10 条「移転される情報の範囲」が実態より狭かった（保護者のメールアドレス・子供の
//   アバター画像・プロフィールが抜けていた）ため DPIA §2.3 の全カテゴリに合わせて書き直し、
//   Stripe の措置（グローバル CBPR 認証）と運営者から Stripe へ送る範囲を明記した。
//   同意した範囲が変わるため再同意を発火させる（2026-09-10 版への同意直後の 2 度目だが、
//   実態より狭い法務文書を本番に残す方が悪い。PO 判断 2026-09-12）。

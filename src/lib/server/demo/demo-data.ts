...
// child_challenges へ一本化された (#3195)。demo の challenge 表示は child_challenge fixture に依存する。
...
// ============================================================
// 旧 DEMO_SIBLING_CHALLENGES (family-wide + 別 progress 配列、#2097 Phase B-5b) は
// #2458 (Path B sibling drop) で物理 drop 済 (2026-05-26)、per-child instance に完全 flip。

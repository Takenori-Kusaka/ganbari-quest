...
function seed() {
	...
	const achievementsData: (typeof schema.achievements.$inferInsert)[] = [
		...
		// --- はじめてバッジ（#0264 初回体験強化） ---
		{
			code: 'streak_2days',
			name: 'れんぞく2にちめ',
			description: '2にちれんぞくでかつどうをきろくした！',
			icon: '🔥',
			category: null,
			conditionType: 'streak_days',
			conditionValue: 2,
		...
		},
		{
			code: 'focus_complete',
			name: '3つのミッション',
			description: 'きょうのおすすめをぜんぶやった！',
			icon: '🎯',
			category: null,
			conditionType: 'focus_complete',
			conditionValue: 1,
			bonusPoints: 15,
			rarity: 'common',
			sortOrder: 6,
		...
		},
		{
			...
			name: 'チェックリストマスター',
			description: 'チェックリストをはじめてぜんぶやった！',
			icon: '✅',
			category: null,
			conditionType: 'first_checklist',
			conditionValue: 1,
			bonusPoints: 15,
			rarity: 'common',
			sortOrder: 7,
		...
		{
			code: 'weekly_adventurer',
			name: '1しゅうかんのぼうけん',
			description: '7にちのうち5にちいじょうかつどうをきろくした！',
			icon: '🗓️',
			category: null,
			conditionType: 'weekly_active',
			conditionValue: 5,
			bonusPoints: 20,
			rarity: 'rare',
			sortOrder: 8,

...
function seed() {
	// ============================================================
	// 活動マスタ（158件 — 学習指導要領準拠 + 家事スキル）
	// baby(0-2歳) 16件は #1301 で削除（baby = 親の準備モード方針 ADR-0011）
	// ============================================================
	...
	// #2295 (EPIC #2294 ①): シーズンイベント seed 削除済 (2026-05-19)
	// season_events / season-pass / monthly-premium-reward 機構は ADR-0012 / ADR-0013 二重違反として撤去。

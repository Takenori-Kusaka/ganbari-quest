...
function seed() {
	...
	const avatarItemsData: (typeof schema.avatarItems.$inferInsert)[] = [
		...
		},
		{
			...
			category: 'background',
			icon: '☁️',
			cssValue: 'linear-gradient(135deg, #e3f2fd, #90caf9)',
			price: 100,
			unlockType: 'purchase',
			rarity: 'common',
			sortOrder: 3,
		},
		{
			...
			category: 'background',
			icon: '🌅',
			cssValue: 'linear-gradient(135deg, #fff3e0, #ffcc80, #ff8a65)',
			price: 200,
			unlockType: 'purchase',
			rarity: 'rare',
			sortOrder: 4,
		},
		{
			...
			category: 'background',
			icon: '🌈',
			cssValue: 'linear-gradient(135deg, #ffcdd2, #fff9c4, #c8e6c9, #bbdefb, #e1bee7)',
			price: 300,
			unlockType: 'purchase',
			rarity: 'rare',
			sortOrder: 5,
		},
		{
			...
			category: 'background',
			icon: '🌌',
			cssValue: 'linear-gradient(135deg, #1a237e, #4a148c, #880e4f)',
			price: 500,
			unlockType: 'purchase',
			rarity: 'epic',
			sortOrder: 6,
		},
		{
			...
			category: 'background',
			icon: '👑',
			cssValue: 'linear-gradient(135deg, #ffd54f, #ffb300, #ff8f00)',
			price: 500,
			unlockType: 'purchase',
			rarity: 'epic',
			sortOrder: 7,
		},
		{
			...
			category: 'background',
			icon: '🌟',
			cssValue: 'linear-gradient(135deg, #e8eaf6, #c5cae9, #9fa8da, #7986cb)',
			price: 0,
			unlockType: 'level',
		...
		// --- きろくおん（サウンド） ---
		{
			...
			category: 'sound',
			icon: '🔔',
			cssValue: '/sounds/record-complete.mp3',
			price: 0,
			unlockType: 'free',
			rarity: 'common',
			sortOrder: 1,
		},
		{
			...
			category: 'sound',
			icon: '🎺',
			cssValue: '/sounds/custom/fanfare.mp3',
			price: 100,
			unlockType: 'purchase',
			rarity: 'common',
			sortOrder: 2,
		},
		{
			...
			category: 'sound',
			icon: '🎮',
			cssValue: '/sounds/custom/chiptune.mp3',
			price: 100,
			unlockType: 'purchase',
			rarity: 'common',
			sortOrder: 3,
		},
		{
			...
			category: 'sound',
			icon: '🎻',
			cssValue: '/sounds/custom/orchestra.mp3',
			price: 200,
			unlockType: 'purchase',
			rarity: 'rare',
			sortOrder: 4,
		},
		{
			...
			category: 'sound',
			icon: '🪄',
			cssValue: '/sounds/custom/magic.mp3',
			price: 200,
			unlockType: 'purchase',
			rarity: 'rare',
			sortOrder: 5,
		},
		{
			...
			category: 'sound',
			icon: '⚡',
			cssValue: '/sounds/custom/power.mp3',
			price: 400,
			unlockType: 'purchase',
			rarity: 'epic',
			sortOrder: 6,
		},
		{
			...
			category: 'sound',
			icon: '🌟',
			cssValue: '/sounds/custom/legend.mp3',
			price: 0,
			unlockType: 'level',
	...
	if (existingAvatarItems.length === 0) {
		...
		// 既存DBに不足しているアイテムを追加（マイグレーション）
		const existingCodes = new Set(existingAvatarItems.map((a) => a.code));
		const missingItems = avatarItemsData.filter((a) => !existingCodes.has(a.code));
		if (missingItems.length > 0) {
			for (const item of missingItems) {
				db.insert(schema.avatarItems).values(item).run();
			}
			console.log(
				`  ✓ avatar_items: added ${missingItems.length} new (${missingItems.map((a) => a.code).join(', ')})`,
			);
		} else {

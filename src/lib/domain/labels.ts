...
export const LP_PAMPHLET_LABELS = {
	...
	k44: '子供の登録：無制限',
	k45: 'オリジナル活動：無制限',
	k46: `家族メンバー招待：${FAMILY_MEMBER_LIMIT_TERMS.standardInvitable}まで（オーナーを含めご家族${FAMILY_MEMBER_LIMIT_TERMS.standardTotal}）`,
	k47: '特別なごほうび設定',
	k48: 'データのダウンロード',
...
export const LP_PRICING_EXTRA_LABELS = {
	...
	k11: 'オリジナル活動の作成：無制限',
	k12: 'チェックリスト自由作成（無制限）',
	k13: `家族メンバー招待：${FAMILY_MEMBER_LIMIT_TERMS.standardInvitable}まで（オーナーを含めご家族${FAMILY_MEMBER_LIMIT_TERMS.standardTotal}）`,
	k14: '特別なごほうび設定（即時付与）',
	...
	k57: `${FAMILY_MEMBER_LIMIT_TERMS.standardInvitable}まで（オーナー含め${FAMILY_MEMBER_LIMIT_TERMS.standardTotal}）`,
	k58: '無制限',
	k59: 'きょうだいランキング',
...
export const LP_PRICING_PHASEB_LABELS = {
	...
	k10: 'オリジナル活動の作成：無制限',
	k11: 'チェックリスト自由作成（無制限）',
	k12: `家族メンバー招待：${FAMILY_MEMBER_LIMIT_TERMS.standardInvitable}まで（オーナーを含めご家族${FAMILY_MEMBER_LIMIT_TERMS.standardTotal}）`,
	k13: '特別なごほうび設定（即時付与）',
	...
	k43: `<td>家族メンバー招待（別端末からアクセス）</td><td class="dash">&#8212;</td><td>${FAMILY_MEMBER_LIMIT_TERMS.standardInvitable}まで（オーナー含め${FAMILY_MEMBER_LIMIT_TERMS.standardTotal}）</td><td class="check">無制限</td>`,
...
export const LP_PAMPHLET_PHASEB_LABELS = {
	...
	k42: `<span class="check">&#x2713;</span>家族メンバー招待：${FAMILY_MEMBER_LIMIT_TERMS.standardInvitable}まで（オーナーを含めご家族${FAMILY_MEMBER_LIMIT_TERMS.standardTotal}）`,

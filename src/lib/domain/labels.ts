...
export const LP_CORELOOP_LABELS = {
	...
	l2Badge: '習慣',
	l2Title: '習慣カードで続ける',
	// #1794: スタンプカード仕様（5 スロット / 1 日 1 回 cap / 月曜自動 redeem）の説明を補強。
	//   「完成します」 → 「ポイントに交換できます」に動詞統一（曜日非依存 + 自動 redeem を明示）。
	l2Desc:
		'1 日 1 回までのおみくじスタンプ。週 7 日中 5 日タップでスタンプカード 1 枚分のポイントに自動交換できます。三日坊主を防ぐ「継続の見える化」（煽らない設計）。',
...
export const LP_INDEX_EXTRA_LABELS = {
	...
	k20: '「はをみがく」「おかたづけ」など、幼児期に身につけたい習慣の候補が 300 件以上用意されています。セットアップで好きなものを選ぶだけ。ログインボーナスで毎日おみくじが 1 回引けて、週 5 日タップでスタンプカード 1 枚分のポイントに自動交換できます。',
	k21: 'デモを見る',
...
export const LP_INDEX_PHASEB_LABELS = {
	...
	k12: '「はをみがく」「おかたづけ」など、幼児期に身につけたい習慣の候補が 300 件以上用意されています。セットアップで好きなものを選ぶだけ。ログインボーナスで毎日おみくじが 1 回引けて、週 5 日タップでスタンプカード 1 枚分のポイントに自動交換できます。',
	...
	// #1793: 自動スリープ + おうえんメッセージ統合カードは「家庭ごとの運用ルールに沿った

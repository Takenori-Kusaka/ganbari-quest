	...
	adminGrowthBook: {
		...
		steps: {
			...
			'growth-book-intro': {
				...
				how: '保護者が入力する操作はありません。お子さまの記録から自動でまとめられ、印刷して手元に残すこともできます。',
				goal: '1 年の成長をまとめて振り返れて、ご家族の思い出として保存できます。',
			},
			// ② 画面の見方 + 最頻操作（年度・お子さまの切り替えと印刷）
			'growth-book-view': {
				title: '画面の見方と印刷',
				what: 'お子さまと年度を切り替えると、その子のその年の記録が月ごと・分野ごとに並びます。印刷ボタンで紙に残せます。',
				how: '1. お子さまと年度を選びます\n2. 月ごと・分野ごとの記録を見ていきます\n3. 印刷ボタンで手元に残します',
				goal: '見たいお子さま・年度の成長を選んで振り返り、必要なら印刷して保存できます。',
				tips: ['成長記録ブックはプレミアムプランで利用できます'],
			},
		},
	},
	adminRewardsRequests: {
		...
		steps: {
			...
			'rewards-requests-act': {
				...
				goal: '承認するとポイントが引かれて交換が確定し、却下するとポイントはお子さまに戻ります。',

...
export const LP_INDEX_EXTRA_LABELS = {
	...
	k20: '「はをみがく」「おかたづけ」など、幼児期に身につけたい習慣の候補が 300 件以上用意されています。最初の準備で好きなものを選ぶだけ。毎日のごほうびでおみくじが 1 回引けて、週 5 日タップでスタンプカード 1 枚分のポイントに自動交換できます。',
	k21: 'デモを見る',
...
export const LP_INDEX_PHASEB_LABELS = {
	...
	k12: '「はをみがく」「おかたづけ」など、幼児期に身につけたい習慣の候補が 300 件以上用意されています。最初の準備で好きなものを選ぶだけ。毎日のごほうびでおみくじが 1 回引けて、週 5 日タップでスタンプカード 1 枚分のポイントに自動交換できます。',
	...
	softFamilySupportDesc:
		// #1912 (F-14): 「自動スリープ」(PC 機能用語) →「使いすぎ防止タイマー」へ顧客語彙化

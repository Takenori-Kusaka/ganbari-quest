...
export const LP_FAQ_PHASEB_LABELS = {
	...
	k19: `管理画面の「プラン・お支払い」→「解約」からいつでも解約できます。解約を申請すると、ご利用プランに応じた読み取り専用の<strong>猶予期間</strong>に入ります（${PLAN_FULL_TERMS.free}: 即時削除 / ${PLAN_FULL_TERMS.standard}: 7 日間 / ${PLAN_FULL_TERMS.family}: 30 日間）。`,
	...
	k32: `お子さまの冒険体験（活動記録・ポイント・レベル・スタンプ・チャレンジ・連続達成ボーナス）は、<strong>${PLAN_FULL_TERMS.free}でもすべてご利用いただけます</strong>。`,
	k33: '有料プランで解放される主な機能:',

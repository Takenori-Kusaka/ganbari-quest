...
export const LP_GROWTH_ROADMAP_LABELS = {
	...
	elementaryChildExperience:
		'ポイントとチャレンジが積み重なり、「次は何をやろう」と自分で計画する楽しさ',
	juniorAge: '中学生',
	juniorRange: '13-15',
	juniorUnit: '歳',
...
export const LP_CORELOOP_LABELS = {
	...
	l2Title: '習慣カードで続ける',
	l2Desc:
		'1 日 1 回までのおみくじスタンプ。1 週間続けるとスタンプカードが完成し、三日坊主を防ぐ「継続の見える化」になります（煽らない設計）。',
...
export const LP_FAQ_LABELS = {
	...
	text66: 'スタンダードプラン以上',
	text67: 'エクスポート対象: お子さま情報、活動、ポイント履歴、シール、称号、チェックリスト。',
...
export const LP_INDEX_EXTRA_LABELS = {
	...
	k20: '「はをみがく」「おかたづけ」など、幼児期に身につけたい習慣の候補が 300 件以上用意されています。セットアップで好きなものを選ぶだけ。ログインボーナスで毎日おみくじが 1 回引けて、スタンプカードが週末に 1 枚完成します。',
	k21: 'デモを見る',
	k22: '漢字 + 情報密度で 15 年継続できる UI',
	k23: '小学生以降 UI: 漢字 / 情報密度 / 学年別プリセット',
	k24: '宿題・習い事・部活・受験まで、学年が上がるにつれて情報密度が増す設計。ポイント履歴とウィークリーチャレンジで「次は何をやろう？」と子供自身が計画を立て、3 歳から 18 歳まで 15 年間、同じアプリで成長を記録できます。',
	k25: 'デモを見る',
	k26: '&#x1F476; 0〜2 歳のお子様は「',
	k27: '準備モード',
	k28: '」でご登録いただけます &#8212; ',
	...
	k32: 'コアループを支える 2 つの工夫',
	k33: '毎日の「活動 → 習慣 → ごほうび」の冒険を、朝の準備と冒険のクライマックスから支える 2 つの工夫です。',
	k34: '朝の準備と冒険のクライマックスの 2 つの工夫が、日々のがんばりを支えます。',
...
export const LP_INDEX_PHASEB_LABELS = {
	...
	k3: '3〜18 歳の毎日の習慣を、ポイント・スタンプ・レベルで冒険に変える。声をかけなくても、自分から動きだす家族時間へ。',
	...
	k12: '「はをみがく」「おかたづけ」など、幼児期に身につけたい習慣の候補が 300 件以上用意されています。セットアップで好きなものを選ぶだけ。ログインボーナスで毎日おみくじが 1 回引けて、スタンプカードが週末に 1 枚完成します。',
	...
	k21: 'コアループを支える 2 つの工夫',
	k22: '毎日の「活動 → 習慣 → ごほうび」の冒険を、朝の準備と冒険のクライマックスから支える 2 つの工夫です。',
...
export const LP_FAQ_PHASEB_LABELS = {
	...
	k32: 'お子さまの冒険体験（活動記録・ポイント・レベル・スタンプ・チャレンジ・連続達成ボーナス）は、<strong>無料プランでもすべてご利用いただけます</strong>。',
	k33: '有料プランで解放される主な機能:',
	...
	k67: 'エクスポート対象: お子さま情報、活動、ポイント履歴、シール、称号、チェックリスト。',

...
export const LP_RETENTION_LABELS = {
	...
	card2Desc:
		'ログイン → おみくじ → スタンプカード、というサイクルは活動記録 (L1) とは独立した L2 習慣エンジン。射幸心ではなく「毎朝アプリを開くこと」を習慣にする設計です。',
...
export const LP_CORELOOP_LABELS = {
	...
	sectionDesc:
		'活動を記録してポイントを貯め、ポイントでごほうびショップの好きなものと交換する。3 層の仕組みが子供の「やりたい」を持続させます。',
	// 親視点サブタイトル
	...
	l2Step1Desc:
		'1 日 1 回のおみくじスタンプ。スタンプのレア度に応じてボーナスポイントが獲得でき、毎朝アプリを開く習慣につながります（日 1 回 cap で煽らない設計）。',
	...
	l3Step1Desc:
		'L1 の活動ポイントと L2 のボーナスポイントが積み上がります。ポイントは経済通貨として機能します。',
	...
	// pamphlet用短文
	pamphletNote:
		'L1 活動記録→ポイント / L2 おみくじスタンプ（習慣形成）/ L3 ごほうびショップ（唯一の出口）の 3 層構造で、毎日のがんばりが本物の報酬になります。',
} as const;

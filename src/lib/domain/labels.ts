...
// #4540 Q4: 解約導線で「記録は残ります」だけを述べると、**無料プランの保持期間を超えた記録が
// 物理削除される**事実が解約を決める瞬間に見えない (PO 決裁: 顧客に有利に見える方向の不正確さ)。
// 特商法「解約とデータの取扱い」(LP_LEGAL_TOKUSHOHO_LABELS.tableContent) と同じ 2 文をここで
// 1 度だけ組み立て、解約導線の各文言が共有する。
//

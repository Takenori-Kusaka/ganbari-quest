...
// ============================================================
// GROWTH_BOOK_TERMS — 年間の成長記録ページ (/admin/growth-book) の呼称 atom (#4654)
// ============================================================
//
// 同じ画面が nav「グロースブック」/ ページ見出し「成長記録ブック」/ レポート内リンク「記録ブック」の
// 3 表記に割れていた (EPIC #4650 B8)。nav の表記を正として atom 1 つに集約し、
// nav / 見出し / リンク / ページタイトルが同じ名前を指すようにする。

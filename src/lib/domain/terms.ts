...
export const CROSS_BORDER_TERMS = {
	...
	/** 起きること。根拠: テナント分離 (ADR-0063) + 保存時・通信時の暗号化 (DPIA §7.1) */
	whatHappens:
		'お子さまの記録とお写真は、暗号化してお預かりします。ほかのご家庭から見えることはありません。',
	/**
	 * 決済会社に渡る範囲。根拠: stripe-service.ts の Checkout Session は
	...
	/** 起きないこと。privacy.html 第 10 条が「この説明とともに表示する」と書いている実体 */
	noNoUse: '広告への利用・第三者への販売・AI の学習への流用は行いません。',
	/** 消せること。抽象的な保証ではなく操作と結果で書く。根拠: 退会時の物理削除 (DPIA §7.1) */

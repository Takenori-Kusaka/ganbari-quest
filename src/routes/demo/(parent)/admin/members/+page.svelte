...
<svelte:head>
	<title>メンバー管理 - がんばりクエスト デモ</title>
</svelte:head>
...
<div class="space-y-6">
	...
	<Card>
		...
		<div class="bg-gray-50 rounded-lg p-6 text-center">
			<div class="w-32 h-32 mx-auto bg-white border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center mb-3">
	...
	<Card>
		...
		<div class="space-y-2">
			<div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
				...
				<div class="flex-1">
					<p class="text-sm font-bold text-gray-700">がんばり太郎</p>
					<p class="text-xs text-gray-400">オーナー</p>
				</div>
			...
			<div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
				<span class="text-2xl">👩</span>
				<div class="flex-1">
					<p class="text-sm font-bold text-gray-700">がんばり花子</p>
					<p class="text-xs text-gray-400">メンバー</p>
				</div>
				<span class="text-xs text-green-500 font-bold">アクティブ</span>
			</div>
		</div>
	...
	<DemoCta
		title="ご家族みんなで使いませんか？"
		description="登録すると、QRコードで簡単にご家族を招待できます。"
	/>
</div>

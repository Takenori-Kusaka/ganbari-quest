...
<div class="px-[var(--spacing-md)] py-[var(--spacing-sm)]">
	...
	{:else if mode === 'edit'}
		<div class="section">
			...
			<h2 class="section-title">ゆめのマンダラチャート</h2>
			<p class="section-desc">まんなかに「ゆめ」をかいて、まわりに「やること」をかこう！</p>
			<MandalaChart bind:chart={mandalaChart} readonly={false} />
		</div>

		<div class="section">
			<h2 class="section-title">みらいのタイムライン</h2>
			<p class="section-desc">しょうらい、どんなじぶんになりたい？</p>
			<CareerTimeline
				bind:timeline3y
				bind:timeline5y
				bind:timeline10y

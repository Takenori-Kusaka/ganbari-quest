...
/** #4682 F4: 履歴の表示件数。見出し (`ADMIN_REWARDS_REQUESTS_LABELS.historySectionTitle`) と同じ SSOT を引く。 */
const HISTORY_LIMIT = REWARD_REQUEST_HISTORY_LIMIT;
...
export const load: PageServerLoad = async ({ locals }) => {
	...
	// (表示件数は REWARD_REQUEST_HISTORY_LIMIT SSOT を引く)。

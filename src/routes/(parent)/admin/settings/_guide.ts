	...
	steps: [
		{
			...
			title: 'おやカギコード設定',
			what: '管理画面へのアクセスを保護するおやカギコード（4〜8桁の数字）を変更できます。初期値は 5086（がんばり）です。お子さまが誤って管理画面に入るのを防ぎます。',
			how: '1. 現在のおやカギコードを入力\n2. 新しいおやカギコード（4〜8桁）を入力\n3. 確認のためもう一度入力\n4. 「おやカギコードを変更」をタップ',
			goal: 'おやカギコードが更新され、次回のログインから新しいコードが必要になります。',
			tips: [
				'おやカギコードを忘れた場合は、ブラウザのCookieをクリアすると再設定できます（ローカル版の場合）',
			],
			position: 'bottom',
		},
		{

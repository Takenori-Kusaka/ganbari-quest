...
- UI ラベル → labels.ts + site/ + tutorial-chapters.ts。**ADR-0037: 文言差し替え前に必ず labels.ts を確認。LP 側は shared-labels.js の `data-label` 注入、HTML 直書きは SEO meta 等の ADR-0037 例外のみ**
- 本番画面 → デモ画面も同等変更

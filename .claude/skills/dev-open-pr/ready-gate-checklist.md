...
ローカル一括検証: `npm run pre-ready -- --pr <num>` (#1775 / ADR-0030)。Step 6 (`check-pr-body.mjs`) が gate 1〜3 を網羅。Step 7 (capture) は手動推奨で gate 4 を補助。
...
# Step 6 (check-pr-body) で gate 1+2+3 を網羅検出
...
| @scripts/pre-ready.mjs | 7 Step 一括検証 CLI |

...
STRIPE_PRICE_MONTHLY=price_xxxxxxxxxxxxx  （月額¥500 のテスト Price ID）
STRIPE_PRICE_YEARLY=price_xxxxxxxxxxxxx   （年額¥5,000 のテスト Price ID）

# 本番用（本人確認完了後）
STRIPE_SECRET_KEY=sk_live_xxxxxxxxxxxxx
STRIPE_WEBHOOK_SECRET=whsec_xxxxxxxxxxxxx
STRIPE_PRICE_MONTHLY=price_xxxxxxxxxxxxx  （月額¥500 の本番 Price ID）
STRIPE_PRICE_YEARLY=price_xxxxxxxxxxxxx   （年額¥5,000 の本番 Price ID）
```
...
- [ ] ビジネス情報入力
- [ ] 月額プラン商品・価格作成 → Price ID メモ
- [ ] 年額プラン商品・価格作成 → Price ID メモ
- [ ] Customer Portal 設定

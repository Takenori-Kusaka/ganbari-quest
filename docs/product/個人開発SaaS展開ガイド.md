...
- GDPR 対応: EU ユーザーーがいなくても将来の拡張を見据えて基本対応しておくと良い
...
- **Lambda + DynamoDB**: サーバーーレスで固定費ゼロスタート。月額費用はアクセス量に比例
...
保護者ロールは従来通り手動操作（開発者情報として requestId を表示）。

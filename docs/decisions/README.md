...
> **注**: #1307 (B9) / #1298 (B3) / #1346 (labels/i18n) 派生で ADR-0011 / ADR-0012 / ADR-0013 / ADR-0014 が同時期に提案されており、10 枠上限ルールの 1-in-1-out は 4 本が揃って merge されるタイミングでまとめて棚卸する（PO 判断）。本表は一時的に 11+ 行に膨らむ可能性がある。

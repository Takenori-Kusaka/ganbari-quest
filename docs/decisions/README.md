...
> **注**: #1307 (B9) / #1298 (B3) / #1346 (labels/i18n) / #1353 (variant/text-wrap) 派生で ADR-0011〜0016 が同時期に提案されており、10 枠上限ルールの 1-in-1-out は 6 本が揃って merge されるタイミングでまとめて棚卸する（PO 判断）。本表は一時的に 11+ 行に膨らむ可能性がある。
...
> 注: ADR-0019〜0024 / ADR-0026〜0031 は CLAUDE.md 一覧および各 ADR ファイルが SSOT。本 README 表への反映は別 PR で追補予定（#1683 scope 外）。

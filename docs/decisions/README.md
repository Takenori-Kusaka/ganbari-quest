...
| 0053 | [Per-child 主軸 + 限定 family master データモデル原則 (6 type SSOT)](0053-per-child-primary-data-model-pattern.md) | accepted | 2026-05-23 |

> 注: ADR-0019〜0024 / ADR-0026〜0031 / ADR-0044 は CLAUDE.md 一覧および各 ADR ファイルが SSOT。本 README 表への反映は別 PR で追補予定（#1683 scope 外、Phase 6 G3 #1924 でも別途扱い）。番号連続性は ADR-0044 / ADR-0045 / ADR-0046 / ADR-0047 / ADR-0049 / ADR-0050 / ADR-0051 / ADR-0052 / ADR-0053 が最新 (renumber 不要)。1-in-1-out 履行は active 27 件超過の現状を踏まえ別 follow-up Issue (#1924 系の継続棚卸) で扱う。
>

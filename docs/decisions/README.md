...
> 注: ADR-0019〜0024 / ADR-0026〜0031 / ADR-0044 は CLAUDE.md 一覧および各 ADR ファイルが SSOT。本 README 表への反映は別 PR で追補予定（#1683 scope 外、Phase 6 G3 #1924 でも別途扱い）。番号連続性は ADR-0044 / ADR-0045 / ADR-0046 が最新 (renumber 不要、#1924 AC4)。

...
| 0017 | [Cognito User Pool 再作成による email mutable 化](0017-cognito-pool-recreation-email-mutable.md) | **rejected (deploy failed, superseded by 0018)** | 2026-04-21 |
...
| 0053 | [LP Visual Regression (pixelmatch CI、#1893 Phase 2)](0053-lp-visual-regression-pixelmatch.md) | accepted | 2026-05-22 |
| 0054 | [家族 master + per-child preference データモデルパターン](0054-family-master-per-child-preference-pattern.md) | accepted | 2026-05-23 |

> 注: ADR-0019〜0024 / ADR-0026〜0031 / ADR-0044 は CLAUDE.md 一覧および各 ADR ファイルが SSOT。本 README 表への反映は別 PR で追補予定（#1683 scope 外、Phase 6 G3 #1924 でも別途扱い）。番号連続性は ADR-0044 / ADR-0045 / ADR-0046 / ADR-0047 / ADR-0049 / ADR-0050 / ADR-0051 / ADR-0052 / ADR-0053 / ADR-0054 が最新 (renumber 不要)。
>
> **2026-05-23 注 (EPIC #2362 PR-1)**: ADR-0054 を表に追加 (元 ADR-0053 は PR #2435 で確保済のため renumber)。1-in-1-out 義務 (README §10) の archive 候補として ADR-0017 (rejected, superseded by 0018) が最有力だが、active 27 件超過の現状とあわせて整理本格実施は別 follow-up Issue (#1924 系の継続棚卸) で扱う。
>

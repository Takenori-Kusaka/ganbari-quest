...
> **注 (2026-05-09 棚卸、#1924 Phase 6 G3)**: 表は「TOP 10 active」と銘打つが、現状の実体は active 33 件で大幅超過。理由は (1) ADR-0011〜0016 (#1307 / #1298 / #1346 / #1353 派生) の同時提案、(2) ADR-0019〜0024 / ADR-0026〜0031 のインフラ・LP セキュリティ系が #1683 scope 外として表追補保留中、(3) ADR-0042 / 0044 / 0045 の追加に対し 1-in-1-out が ADR-0009 archive (`#1924`) のみで未消化。整理の本格実施は別 Issue (棚卸 6 ヶ月毎、または ADR-0027 follow-up) で扱う。Phase 6 G3 では (a) ADR-0045 を表に追加、(b) ADR-0009 を archive へ移動、(c) per-ADR ボリューム上限ルール違反の棚卸結果を「棚卸レポート」に記録、までを完遂する。
...
| 0014 | [labels / i18n 機構選定（OSS 先調査）](0014-labels-i18n-mechanism.md) | proposed | 2026-04-21 |
| 0015 | [年齢帯 variant 管理アーキテクチャ](0015-age-tier-variant-architecture.md) | proposed | 2026-04-21 |
| 0016 | [日本語テキスト折り返し方針](0016-japanese-text-wrap.md) | proposed | 2026-04-21 |
| 0018 | [Cognito User Pool 論理 ID 変更による明示的 Replacement](0018-cognito-user-pool-logical-id-replacement.md) | accepted | 2026-04-21 |
| 0019 | [CDK Replacement 検知を deploy 前必須ゲートとして組み込む](0019-cdk-replacement-detection-gate.md) | accepted | 2026-04-24 |
| 0020 | [NUC スケジューラ方式選定 — node-cron + 専用コンテナ](0020-nuc-scheduler-choice.md) | accepted | 2026-04-24 |
| 0021 | [Cognito Pool 移行におけるユーザー保全戦略](0021-cognito-pool-migration-user-preservation.md) | accepted | 2026-04-24 |
| 0022 | [admin bypass 禁止と ganbariquestsupport-lab QM Approve 体制の確立](0022-admin-bypass-disable-qm-approve.md) | accepted | 2026-04-25 |
...
| 0027 | [チェックリスト責務の純化と must 属性実装による責務分離](0027-checklist-purification-and-must-attribute.md) | accepted | 2026-04-30 |
| 0028 | [Pre-PMF 期 founder 直対応動線は LP 不要、footer mailto に集約](0028-pre-pmf-founder-inquiry-removal.md) | accepted | 2026-04-30 |
...
| 0032 | [LP 静的コンテンツ コンポーネント設計原則 (SOLID 監査 + 共通化方針)](0032-lp-static-content-component-design.md) | accepted | 2026-05-02 |
| 0042 | [LP CSS Spacing/Layout 3 層トークン化 (Base → Semantic → Component SSOT)](0042-lp-spacing-layout-tokens.md) | accepted | 2026-05-02 |
| 0044 | [Birthday Input Component Choice](0044-birthday-input-component-choice.md) | accepted | 2026-04-22 |
...
| 0050 | [Parent-Gate Session Cookie 署名方式: cookie-signature (OSS 4 件比較)](0050-parent-gate-session-cookie-signature.md) | accepted | 2026-05-20 |
...
| 0057 | [Vale vs. Node.js Prose Linter 選定理由 (#2555)](0057-vale-vs-node-prose-linter.md) | accepted | 2026-05-28 |
| 0058 | [プラン命名 family → premium rename (上位 SSOT 改訂、PO 判断適用)](0058-plan-naming-family-to-premium-rename.md) | accepted | 2026-05-29 |
| 0059 | [Phase 7 統合 PR cutover シーケンスと kill switch 戦略 (Stripe 公式 5 phase + env var 2 件、LaunchDarkly / Unleash 不採用)](0059-phase7-cutover-sequence.md) | accepted | 2026-05-30 |

> 注 (2026-05-27 P0 ADR cleanup で追補): ADR-0019〜0024 / ADR-0026〜0031 / ADR-0044 を本表に追補完了。旧 ADR-0017 行は #2097 (2026-05-15) で archive 移動済のため表から削除済 (rejected ADR は archive で historical record として保持)。番号連続性は ADR-0044 / ADR-0045 / ADR-0046 / ADR-0047 / ADR-0049 / ADR-0050 / ADR-0051 / ADR-0052 / ADR-0053 / ADR-0055 / 0056 / 0057 / 0058 / 0059 が最新 (renumber 不要)。1-in-1-out 履行は active 40 件超過の現状を踏まえ、月 1 棚卸 (docs/CLAUDE.md §ADR 月 1 棚卸、次回 2026-06 最終週) で継続的に消化する。ADR-0059 (#2665) 起票時の 1-in-1-out 履行は 2026-06 棚卸で archive 候補 (ADR-0014 proposed のまま / ADR-0017 rejected archive 候補 / per-ADR ボリューム超過 6 件) のいずれかを archive 移動 (本 PR scope 外、月 1 棚卸で別 PR 実施)。
>

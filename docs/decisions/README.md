...
| 0025 | [LP SSOT 注入機構の innerHTML 化 + XSS 設計（DOMPurify）](0025-lp-ssot-html-injection-with-xss-protection.md) | proposed | 2026-04-29 |

> 注: ADR-0019〜0024 は CLAUDE.md 一覧および各 ADR ファイルが SSOT。本 README 表への反映は別 PR で追補予定（#1683 scope 外）。

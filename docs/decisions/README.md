...
> 注: ADR-0019〜0024 / ADR-0026〜0031 / ADR-0044 は CLAUDE.md 一覧および各 ADR ファイルが SSOT。本 README 表への反映は別 PR で追補予定（#1683 scope 外、Phase 6 G3 #1924 でも別途扱い）。番号連続性は ADR-0044 / ADR-0045 / ADR-0046 / ADR-0047 / ADR-0048 が最新 (renumber 不要、#1924 AC4)。ADR-0017 は #2097 で archive 送り (1-in-1-out: ADR-0048 追加と組合せ)。
...
| 0017 | [Cognito User Pool 再作成による email mutable 化](archive/0017-cognito-pool-recreation-email-mutable.md) — **rejected (deploy failed, superseded by ADR-0018)**, archived 2026-05-15 (#2097 1-in-1-out with ADR-0048) |

...
- **実 retrospective 出力**: `docs/rationale/NN-claude-code-retrospective-YYYY-MM.md` 連番 (NN = 06, 07, 08, ...)
...
2. **テンプレ複製**: `cp docs/rationale/_template-claude-code-retrospective.md docs/rationale/06-claude-code-retrospective-2026-11.md`

...
- [ADR-0025](decisions/0025-lp-ssot-html-injection-with-xss-protection.md) — LP SSOT 注入機構の innerHTML 化 + XSS 設計（DOMPurify）（proposed, #1683, 2026-04-29）— 案 A architecture 先行、693 件 (LP 339 + Legal 354) 全件 SSOT 化の前提

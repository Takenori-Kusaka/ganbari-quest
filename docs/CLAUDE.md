...
- [ADR-0023](decisions/0023-infra-pr-required-baseline.md) — インフラ PR 必須要件: ENV silent skip 禁止 + secrets validation + post-deploy smoke test + alarm（accepted, #1586, 2026-04-27）

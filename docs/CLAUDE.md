...
詳細: `feedback_qm_continuous_responsibility.md` / Issue #2225 の Phase 2 (CI gate `scripts/check-large-docs-pr.mjs` / `check-ssot-deletion.mjs`) と Phase 3 (`.github/PULL_REQUEST_TEMPLATE.md` 「巨大変更時の分割計画」セクション追加) は別 follow-up Issue で段階導入判断。

...
> 注: 旧採番 ADR 25 件は `docs/decisions/archive/` に退避済み（#1262 sub-B 完了）。5 件は削除済み（0002 / 0008 / 0009 / 0016 / 0027 — supersede チェーン終結）。詳細は `docs/decisions/README.md` の archive 一覧参照。

...
export const SQL_TABLES = `
	...
	-- #3213: auto_challenges 廃止。週次自動チャレンジは child_challenges に一本化。
	...
	CREATE INDEX idx_viewer_tokens_tenant ON viewer_tokens(tenant_id);
	...
	CREATE UNIQUE INDEX idx_daily_battles_child_date ON daily_battles(child_id, date);
	CREATE INDEX idx_daily_battles_child ON daily_battles(child_id);

	-- ============================================================
	-- enemy_collection (#605)
	-- ============================================================
	...
	-- Stripe Webhook 冪等性 dedup (30 日 retention、ADR-0049 整合)
	...
	CREATE INDEX idx_stripe_webhook_events_type_result
...
const ALL_TABLES = [
	// #2641 / Phase 5 子 3 / Phase 7 PR-1: Stripe Webhook 冪等性 dedup

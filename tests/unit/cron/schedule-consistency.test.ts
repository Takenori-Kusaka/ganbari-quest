...
const DOCUMENTED_EXCLUSIONS: DocumentedExclusion[] = [
	{
		...
		scope: 'cdk-cron-jobs',
		reason:
			'第 21 回統合 (#4304) で #4311 を revert し EventBridge Rule を作らない状態に戻した。復活は 3 条件が揃うまで行わない: PR #4340 の merge / #4327 の 4 条件 (予告・観測・停止・復旧) の解消 / dry-run の件数を出してオーナーが再有効化を承認',
		issue: '#4327',
	},
	{

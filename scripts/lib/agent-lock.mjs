 ...
 *
 * @param {string} key
 * @param {{ownerPid?: number | null, sessionId?: string | null, ownerVia?: string | null, agent?: string | null, target?: string | null, cwd?: string | null, ttlMs?: number, now?: number}} opts

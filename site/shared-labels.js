...
(function () {
	...
	const LP_LABELS = {
		...
		"legalDisclaimer": {
			"cancelDisclaimer": "※解約後はプラン別の読み取り専用猶予期間（無料 即時 / スタンダード 7 日 / ファミリー 30 日）後にすべてのデータが完全に削除されます。日割り返金はありません。",
		...
		"growthRoadmap": {
			...
			"pageHeroLead": "お子さまの成長に合わせて UI と機能が変化。最後は「アプリを使わなくても自分で計画できる」自律へ。",
		...
		"pricing": {
			...
			"ctaDisclaimerBadges": "✅ クレジットカード登録不要 ✅ 自動課金なし ✅ いつでも解約できます（契約期間の縛りなし）",
			...
			"faqAfterTrialA": "7日間の無料体験終了後は無料プランに移行します。有料プランをご希望の場合は、ご家族の見守り画面からアップグレードしてください。クレジットカードの事前登録は不要です。無料体験中に作成したオリジナル活動・ごほうび・チェックリスト・シール・レベルは保持されますが、活動履歴・ポイント獲得履歴・ログインボーナス履歴は無料プランの保持期間（90 日）を超えたものから順次削除されます。",

...
(function () {
	...
	const LP_LABELS = {
		...
		"faq": {
			...
			"text19": "プラン別の猶予期間（読み取り専用）— 無料: 即時削除 / スタンダード: 7 日 / ファミリー: 30 日",
			...
			"text27": "プラン別の猶予期間中（無料: 不可 / スタンダード: 7 日 / ファミリー: 30 日）であれば、ご家族の見守り画面から解約申請を取り消して有料プランを継続できます。",
		...
		"floatingCta": {
			...
			"midHref": "https://ganbari-quest.com/switch?mode=demo",
		...
		"indexB": {
			...
			"k13": "<a href=\"https://ganbari-quest.com/switch?mode=demo\" class=\"btn btn-demo\">デモを見る</a>",
			"k14": "漢字 + 情報密度で 15 年継続できる UI",
			"k15": "小学生以降 UI: 漢字 / 情報密度 / 学年別プリセット",
			"k16": "小学校以降はより自律的により多くの活動をより楽しく",
			"k17": "<a href=\"https://ganbari-quest.com/switch?mode=demo\" class=\"btn btn-demo\">デモを見る</a>",
			...
			"k18": "&#x1F476; 0〜2 歳のお子さまは「<strong>準備モード</strong>」でご登録いただけます — <a href=\"https://ganbari-quest.com/switch?mode=demo\">デモを見る</a>",
			"k19": "&#x1F9D1;&#x200D;&#x1F4BB; 親の視点",
			"k20": "&#x1F9D2; 子供の視点",
		...
		"faqB": {
			...
			"k18": "途中で解約するとどうなりますか？",
			"k19": "ご家族の見守り画面の「プラン・お支払い」→「解約」からいつでも解約できます。解約を申請すると、ご利用プランに応じた読み取り専用の<strong>猶予期間</strong>に入ります（無料プラン: 即時削除 / スタンダードプラン: 7 日間 / ファミリープラン: 30 日間）。",
			...
			"k27": "プラン別の猶予期間中（無料: 不可 / スタンダード: 7 日 / ファミリー: 30 日）であれば、ご家族の見守り画面から解約申請を取り消して有料プランを継続できます。",
		...
		"legalPrivacy": {
			...
			"section6": "<h2>第6条（データの削除）</h2><ol><li><strong>個別データの削除</strong>: 特定の活動記録やお子さまの情報の削除は、本サービスのご家族の見守り画面から即時実行できます。</li><li><strong>アカウント全体の削除</strong>: アカウント削除を申請後、ご利用プランに応じた猶予期間を設けます（無料プラン: 即時削除 / スタンダードプラン: 7日間 / ファミリープラン: 30日間）。猶予期間中は削除の取消しが可能です。</li><li><strong>バックアップからの完全消去</strong>: アカウント削除後90日以内に、バックアップデータからも完全に消去されます。</li></ol>",
		...
		"legalTerms": {
			...
			"section13": "<h2>第13条（利用者データの取扱い）</h2><ol><li>利用者は、自己のコンテンツについて、いつでも削除を申請することができます。</li><li>アカウント削除を申請した場合、ご利用プランに応じた猶予期間（無料プラン: 即時削除 / スタンダードプラン: 7日間 / ファミリープラン: 30日間）の後、全データが完全に削除されます。猶予期間中は削除の取消しが可能です。</li><li>運営者はデータのバックアップを実施していますが、データの復旧を保証するものではありません。</li></ol>",

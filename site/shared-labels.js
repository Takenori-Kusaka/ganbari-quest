...
(function () {
	...
	const LP_LABELS = {
		...
		"faq": {
			...
			"text107": "プレミアムプラン",
			"text108": "無制限",
			"text109": "招待した保護者はお子さまの記録の確認・コメントやスタンプ送付・設定変更ができます。閲覧のみの共有をご希望の場合は、プレミアムプランの閲覧リンクをお使いください。",
			"text110": "技術的なご質問",

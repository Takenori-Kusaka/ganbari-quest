...
(function () {
	...
	const LP_LABELS = {
		...
		"legalDisclaimer": {
			"cancelDisclaimer": "※「いつでも解約 OK」について: 解約申請後はプランに応じた読み取り専用の猶予期間（スタンダードプラン 7 日 / ファミリープラン 30 日）が設けられ、猶予期間中は閲覧・エクスポートが可能です。猶予期間経過後にすべてのデータが完全に削除されます。日割り返金はありません。",
			"cancelDisclaimerLinks": "FAQ / 特定商取引法に基づく表記",
			"cancelDisclaimerCta": "※「いつでもキャンセル可能」について: 解約申請後はプランに応じた猶予期間（スタンダードプラン 7 日 / ファミリープラン 30 日）後にすべてのデータが完全に削除されます。",

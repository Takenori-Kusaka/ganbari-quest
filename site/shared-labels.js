...
(function () {
	...
	const LP_LABELS = {
		...
		"pricing": {
			...
			"faqCancelA": "いいえ。解約してもデータは削除されません。現在の請求期間の終了日までは有料プランをそのままご利用いただけ、その後は無料プランへ自動的に切り替わります（お子さまの記録は残ります）。無料プランの履歴保持期間は 90 日です。90 日を超えた記録は削除され、復元できません（再契約でも戻りません）。必要な記録は保持期間内にエクスポートしてください。データそのものを消すのはアカウント退会のお手続きです。",
		...
		"faq": {
			...
			"text22": "必要な記録がある場合は、ご家族の見守り画面からデータをエクスポートしてください。",
		...
		"faqB": {
			...
			"k22": "必要な記録がある場合は、ご家族の見守り画面からデータをエクスポートしてください。",

...
(function () {
	...
	const LP_LABELS = {
		...
		"pricing": {
			...
			"faqPlanChangeA": "はい。スタンダード↔ファミリーの切り替えが可能です。ご家族の見守り画面の「プラン・お支払い」からお手続きいただけます。プラン変更方法についてご不明な点は、お問い合わせください。",
			...
			"planFamilyDirectCta": "今すぐ購入（プレミアム）",
		...
		"faq": {
			...
			"text19": "解約してもデータは削除されません。現在の請求期間の終了日までは有料プランをそのままご利用いただけ、その後は無料プランへ自動的に切り替わります。",
			"text20": "無料プランへ移行した後も、お子さま・活動・ポイントなどのデータは残ります",
			"text21": "90 日を超えた記録は削除され、復元できません（再契約でも戻りません）",
		...
		"faqB": {
			...
			"k18": "途中で解約するとどうなりますか？",
			"k19": "ご家族の見守り画面の「プラン・お支払い」→「請求管理ページを開く」（Stripe の請求管理ページ）からいつでも解約できます。解約しても<strong>データは削除されません</strong>。現在の請求期間の終了日までは有料プランをそのままご利用いただけ、その後は無料プランへ自動的に切り替わります。",
			"k20": "無料プランへ移行した後も、お子さま・活動・ポイントなどのデータは残ります",
			"k21": "90 日を超えた記録は削除され、復元できません（再契約でも戻りません）",
			...
			"k106": "祖父母や親戚も使えますか？",
			"k107": "<strong>プレミアムプラン</strong>では、保護者側のメンバーを<strong>無制限</strong>に招待できます。祖父母・おじおば・離れて暮らす親御さまなどが、同じお子さまの成長を見守れます（スタンダードプランは 4 人までの招待が可能です）。",
		...
		"legalTerms": {
			...
			"section7": "<h2>第7条（料金および支払い）</h2><ol><li>本サービスの基本機能は無料でご利用いただけます。一部の機能は有料プランへの加入が必要です。料金の詳細は本サービス内の料金ページに記載します。</li><li>有料プランの支払いは、運営者が指定する決済サービスを通じて行われます。</li><li>有料プランは契約期間ごとに自動更新されます。自動更新の停止（解約）は、次回更新日の前日までにご家族の見守り画面の「プラン・お支払い」→「請求管理ページを開く」（Stripe の請求管理ページ）から行うことができます。</li><li>解約後も、支払い済み期間の終了日まで有料プランの機能をご利用いただけます。</li><li>日割り計算による返金は行いません。</li><li><strong>解約とアカウント削除の違い</strong>: 解約はサブスクリプションの自動更新停止のみを行うものであり、利用者のデータは無料プランへ移行して保持されます（保持期間は本規約第13条に定めます）。データを完全に削除したい場合は、本サービスにログインのうえ、設定画面の「アカウント削除」から本人が実施してください。詳細は第13条に定めます。</li></ol>",
			"section8": "<h2>第8条（無料トライアル）</h2><ol><li>有料プランには無料トライアル期間が含まれる場合があります。期間の詳細は本サービス内に記載します。</li><li>無料トライアル期間中に解約した場合、料金は発生しません。</li><li>無料トライアル期間終了後、自動的に無料プランに移行します。有料プランへの移行はお客さまご自身でご家族の見守り画面より手続きしていただく必要があります。</li><li>無料トライアルは、1アカウントにつき1回のみご利用いただけます。</li></ol>",
			...
			"section14": "<h2>第14条（卒業 — ポジティブな解約について）</h2><ol><li><strong>哲学</strong>: 本サービスは、お子さまが日常活動を自律的に行えるようになった時点で、本サービスの継続利用を推奨しません。これを「卒業」と呼びます。卒業は、お子さまが成長し、本サービスの動機づけがなくても自分の力で日々の活動に取り組めるようになった、ポジティブな節目です。</li><li><strong>卒業時の手続き</strong>: 利用者は、本サービスのご家族の見守り画面から「卒業手続き」を行うことで、本契約を終了し、データのエクスポートまたは削除を選択することができます。具体的な手続き UI は別途提供します（実装は今後のリリースで提供予定）。</li><li><strong>残ポイントの還元</strong>: 卒業時に保有しているポイントについて、現金または物品での還元を希望される場合は、別途運営者までご連絡ください。還元の対象範囲・方法については、運営者が個別に案内します。</li><li><strong>通常の解約との関係</strong>: 卒業は、利用者の意思による契約終了の一形態であり、本規約第7条に定める通常の解約手続きと並存します。利用者は、卒業手続きの代わりに通常の解約手続きを選択することもできます。</li></ol>",

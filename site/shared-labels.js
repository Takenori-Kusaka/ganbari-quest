...
(function () {
	...
	const LP_LABELS = {
		...
		"legalDisclaimer": {
			"cancelDisclaimer": "※解約後、スタンダードは 7 日間、プレミアムは 30 日間はデータを見られます（無料は即時）。その後すべてのデータが完全に削除されます。日割り返金はありません。",
		...
		"pricing": {
			...
			"faqCancelA": "プランによって異なります。スタンダードプランは解約申請から 7 日間、ファミリープランは解約申請から 30 日間はデータを見られます。その後すべてのデータが完全に削除されます（復旧不可）。この期間中はログインしてダウンロードが可能です。",
		...
		"faq": {
			...
			"text19": "プラン別の猶予期間（読み取り専用）— 無料: 即時削除 / スタンダード: 7 日 / プレミアム: 30 日",
			"text20": "猶予期間中: データの閲覧・エクスポートが可能（新規作成・編集は不可）",
			"text21": "猶予期間終了後: すべてのデータが完全に削除",
			"text22": "バックアップが必要な場合は、猶予期間中にご家族の見守り画面からデータのバックアップをお願いします。",
			...
			"text28": "猶予期間終了後にデータが完全に削除された場合は、新規お申し込みからのやり直しとなります（過去のデータ復旧はできません）。",
			"text29": "料金・課金について",
			...
			"text76": "ご家族の見守り画面から退会（アカウント削除）を申請できます。申請後 30 日間の猶予期間があり、その間に申請を取り消すこともデータをエクスポートすることもできます。",
		...
		"faqB": {
			...
			"k18": "途中で解約するとどうなりますか？",
			"k19": "ご家族の見守り画面の「プラン・お支払い」→「解約」からいつでも解約できます。解約を申請すると、ご利用プランに応じた読み取り専用の<strong>猶予期間</strong>に入ります（無料プラン: 即時削除 / スタンダードプラン: 7 日間 / プレミアムプラン: 30 日間）。",
			"k20": "猶予期間中: データの閲覧・エクスポートが可能（新規作成・編集は不可）",
			"k21": "猶予期間終了後: すべてのデータが完全に削除",
			"k22": "バックアップが必要な場合は、猶予期間中にご家族の見守り画面からデータのバックアップをお願いします。",
			...
			"k28": "猶予期間終了後にデータが完全に削除された場合は、新規お申し込みからのやり直しとなります（過去のデータ復旧はできません）。",
			...
			"k76": "ご家族の見守り画面から退会（アカウント削除）を申請できます。申請後 30 日間の猶予期間があり、その間に申請を取り消すこともデータをエクスポートすることもできます。",

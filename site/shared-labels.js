...
(function () {
	...
	const LP_LABELS = {
		...
		"growthRoadmap": {
			...
			"pageMetaDescription": "がんばりクエストの 5 ステージ成長ロードマップ。幼児（3-5歳）から高校生（16-18歳）、そして「卒業」まで、UI と機能が成長に合わせて変化していく様子を実画面付きで紹介。",
			"breadcrumbHome": "ホーム",
		...
		"indexB": {
			...
			"k69": "仕組みを詳しく知りたい方へ &#8594;",
			"k70": "よくあるご質問",
			"k71": "保護者の皆さまから特によくいただく 3 つ。他のご質問は <a href=\"faq.html\" class=\"nav-text\">よくあるご質問</a> をご覧ください。",
			...
			"k78": "料金・兄弟姉妹・年齢モード・エクスポート等、他のご質問は <a href=\"faq.html\">よくあるご質問</a> へ。",
			...
			"k87": "保護者の皆さまから特によくいただく 4 つ。他のご質問は <a href=\"faq.html\" class=\"nav-text\">よくあるご質問</a> をご覧ください。",

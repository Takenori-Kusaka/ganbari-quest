...
(function () {
	...
	const LP_LABELS = {
		...
		"faq": {
			...
			"text116": "記録には通信が必要です。オフラインでも、直前に開いた画面の表示はキャッシュから復元されますが、**記録の保存はできません**（電波が戻ってからお試しください）。新規お申し込み・決済も通信が必要です。",
			"text117": "旅行中や電波の弱い場所では記録の保存ができません。電波の届く場所に戻ってから記録してください（後からその日の記録を追加できます）。",
		...
		"faqB": {
			...
			"k114": "オフラインでも使えますか？",
			"k115": "記録には通信が必要です。オフラインでも、直前に開いた画面の表示はキャッシュから復元されますが、**記録の保存はできません**（電波が戻ってからお試しください）。新規お申し込み・決済も通信が必要です。",

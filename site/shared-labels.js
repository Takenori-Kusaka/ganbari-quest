...
(function () {
	...
	const LP_LABELS = {
		...
		"pricing": {
			...
			"faqFreeA": "はい。プリセットの活動・チェックリスト・ごほうびで基本的な機能はすべてお使いいただけます。お子さまの冒険体験（レベル、ポイント、おみくじ、スタンプカード、毎日のごほうび）は無料プランでも一切制限ありません。ただしオリジナルごほうびの登録（プリセットにない商品をご自身で作って登録すること）はスタンダードプラン以上の機能です。",
		...
		"pricingB": {
			...
			"k7": "90日間の履歴保持",
			"k8": "メールサポート（標準）",
			"k8b": "ごほうび: プリセットから追加（オリジナルごほうびの登録はスタンダード以上）",
			"k9": "お子さまの登録人数：無制限",
			"k10": "オリジナル活動の作成：無制限",
			"k11": "チェックリスト自由作成（無制限）",
			...
			"k39": "<td>オリジナルごほうびの登録</td><td class=\"dash\">&#8212;</td><td class=\"check\">&#10003;</td><td class=\"check\">&#10003;</td>",

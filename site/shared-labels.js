...
(function () {
	...
	const LP_LABELS = {
		...
		"coreloop": {
			...
			"l3Badge": "ごほうび",
			"l3Title": "ごほうびショップで交換",
			"l3Desc": "貯めたポイントはごほうびショップが唯一の出口。実物のプレゼント・お小遣い・特権などを親がプリセットから選んで並べ、子供が自分で選んで交換できます。オリジナルのごほうびの作成・編集（ポイントの調整を含む）はスタンダード以上です。",
		...
		"pricing": {
			...
			"faqFreeA": "はい。プリセットの活動・チェックリスト・ごほうびで基本的な機能はすべてお使いいただけます。お子さまの冒険体験（レベル、ポイント、おみくじ、スタンプカード、毎日のごほうび）は無料プランでも一切制限ありません。ただしオリジナルのごほうびの作成・編集（ポイントの調整を含む）はスタンダードプラン以上の機能です。プリセットにないごほうびをご自身で作ることと、取り込んだごほうびの名前やポイントを変えることがこれにあたります。",
		...
		"indexB": {
			...
			"k39": "成長の記録（成長レポート）",
			"k40": "5 つの軸のバランスをレーダーで表示。同年齢の平均と重ねて見られます。",
			...
			"k45": "設定の自由度",
			"k46": "<strong>ご家庭ごとに自由なカスタマイズ</strong>。活動の種類・ポイント配分を、お子さまに合わせて細かく調整できます。ごほうびはプリセットから追加でき、オリジナルのごほうびの作成・編集（ポイントの調整を含む）はスタンダード以上です。",
			"k47": "まずは無料、必要なら月 ¥500〜",
			...
			"pwaAndroidSteps": "画面右上の「⋮」→「ホーム画面に追加」または「アプリをインストール」→「追加」（見当たらないときは「保存して共有」の中）",
			"pwaIosTitle": "iPhone / iPad（Safari）",
			"pwaIosSteps": "画面下の「共有」（□に↑。無いときは「…」の中）→「ホーム画面に追加」→「追加」",
			"pwaNote": "アプリストアからのダウンロードは不要です。追加はログインしたあとのアプリの画面で行ってください（この紹介ページからは追加できません）。あとからアプリの「設定」→「サポート」でも手順を確認できます。"
		},
		"pricingB": {
			"k1": "お子さまの登録：2人まで",
			"k2": "プリセット活動の利用",
			...
			"k7": "90日間の履歴保持",
			"k8": "メールサポート（標準）",
			"k8b": "ごほうび: プリセットから追加。オリジナルのごほうびの作成・編集（ポイントの調整を含む）はスタンダード以上",
			"k9": "お子さまの登録人数：無制限",
			"k10": "オリジナル活動の作成：無制限",
			"k11": "チェックリスト自由作成（無制限）",
			"k12": "家族メンバー招待：3人まで（オーナーを含めご家族4人）",
			"k13": "オリジナルのごほうびの作成・編集（ポイントの調整を含む）",
			...
			"k39a": "<td>プリセットごほうびの利用</td><td class=\"check\">&#10003;</td><td class=\"check\">&#10003;</td><td class=\"check\">&#10003;</td>",
			"k39": "<td>オリジナルのごほうびの作成・編集（ポイントの調整を含む）</td><td class=\"dash\">&#8212;</td><td class=\"check\">&#10003;</td><td class=\"check\">&#10003;</td>",
		...
		"pamphletB": {
			...
			"k43": "<span class=\"check\">&#x2713;</span>オリジナルのごほうびの作成・編集（ポイントの調整を含む）",
		...
		"legalSla": {
			...
			"section5": "<h2>第5条（障害通知）</h2><ol><li>サービス障害が発生した場合、運営者は本サービス内のお知らせにて状況を通知します。重大な障害の際は、登録メールアドレスへご連絡する場合があります。</li><li>障害の検知はデプロイ時の自動検証および1時間ごとの定期ヘルスチェックにより行われ、異常を検知した場合は速やかに対応を開始し通知します。</li></ol>",

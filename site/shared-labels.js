...
(function () {
	...
	const LP_LABELS = {
		...
		"coreloop": {
			...
			"l2Badge": "習慣",
			"l2Title": "習慣カードで続ける",
			"l2Desc": "1 日 1 回までのおみくじスタンプ。1 週間続けるとスタンプカードが完成し、三日坊主を防ぐ「継続の見える化」になります（煽らない設計）。",
			"l3Badge": "ごほうび",
			"l3Title": "ごほうびショップで交換",
		...
		"legalDisclaimer": {
			...
			"cancelDisclaimerCta": "※解約後はプラン別の猶予期間（無料 即時 / スタンダード 7 日 / ファミリー 30 日）後にすべてのデータが完全に削除されます。",
		...
		"growthRoadmap": {
			...
			"elementaryChildExperience": "ポイントとチャレンジが積み重なり、「次は何をやろう」と自分で計画する楽しさ",
			"juniorAge": "中学生",
			"juniorRange": "13-15",
			"juniorUnit": "歳",
		...
		"indexB": {
			...
			"softBenefitFamilySupport": "<strong>親が観測できること</strong>: 設定時間で自動スリープが働き、おうえんメッセージは子供が読むと既読が付く"
		},
		"pricingB": {
			"k1": "お子さまの登録：2人まで",
			"k2": "プリセット活動の利用",

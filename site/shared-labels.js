...
(function () {
	...
	const LP_LABELS = {
		...
		"faq": {
			...
			"text107": "プレミアムプラン",
			"text108": "無制限",
			"text109": "招待した保護者は保護者として、お子さまの記録の確認と活動の記録ができます。閲覧のみの共有をご希望の場合は、プレミアムプランの閲覧リンク（閲覧専用）をお使いください。",
			"text110": "技術的なご質問",
		...
		"faqB": {
			...
			"k108": "招待した保護者は保護者として、お子さまの記録の確認と活動の記録ができます。閲覧のみの共有をご希望の場合は、プレミアムプランの閲覧リンク（閲覧専用）をお使いください。",

...
(function () {
	...
	const LP_LABELS = {
		...
		"faq": {
			...
			"text124": "初回のご返信は48 時間以内（営業日ベース）を目標としています。",
			"text125": "無料で始める",
			"text126": "デモを見る",
		...
		"faqB": {
			...
			"k120": "ほかにご質問はありますか？",
			"k121": "上記にないご質問や、ご要望・フィードバックは、メールでお気軽にお寄せください。初回のご返信は48 時間以内（営業日ベース）を目標としています。",
			"k122": "無料で始める",
			"k123": "デモを見る",
		...
		"legalSla": {
			...
			"section6": "<h2>第6条（サポート対応）</h2><p>お問い合わせは<a href=\"https://github.com/Takenori-Kusaka/ganbari-quest/issues\">GitHub Issues</a>または<a href=\"mailto:ganbari.quest.support@gmail.com\" data-contact-context=\"SLA\">メール</a>にて24時間受け付けています。初回応答は48 時間以内（営業日ベース）を目標としています。対応言語は日本語です。</p><p>個人運営のため、応答が遅れる場合があります。ご理解をお願いいたします。</p>",

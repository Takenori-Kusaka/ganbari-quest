...
(function () {
	...
	const LP_LABELS = {
		...
		"pricing": {
			...
			"faqPlanChangeA": "はい。スタンダード↔ファミリー、月額↔年額の切り替えが可能です。ご家族の見守り画面の「プラン・お支払い」→「プラン変更・支払い管理」からお手続きいただけます。プラン変更方法についてご不明な点は、お問い合わせください。",
		...
		"licenseKey": {
			...
			"text7": "購入完了後、ご登録のメールアドレスに自動で送信されます。ご家族の見守り画面の「ライセンス」ページでもいつでも確認できます。",
			"text8": "適用手順（3ステップ）",
			"text9": "ご家族の見守り画面にログイン",
			"text10": "ライセンスキーを入力",
			"text11": "「適用する」を押す",
			"text12": "ライセンス管理を開く",
			"text13": "ご注意",
			...
			"text21": "ご家族の見守り画面の「ライセンス」ページでキーを直接確認する",
			"text22": "ご家族の見守り画面の「せってい」→「お問い合わせ」からサポートに連絡する",
			...
			"text45": "購入後にメールでお届けするキーを、ご家族の見守り画面から入力するだけで有料機能が使えるようになります。",
		...
		"faq": {
			...
			"text22": "バックアップが必要な場合は、猶予期間中にご家族の見守り画面からデータエクスポート（JSON / CSV）をお願いします。",
			...
			"text27": "プラン別の猶予期間中（無料: 不可 / スタンダード: 7 日 / プレミアム: 30 日）であれば、ご家族の見守り画面から解約申請を取り消して有料プランを継続できます。",
			...
			"text58": "はい。ご家族の見守り画面の「プラン・お支払い」→「プラン変更・支払い管理」からお手続きいただけます。",
		...
		"faqB": {
			...
			"k22": "バックアップが必要な場合は、猶予期間中にご家族の見守り画面からデータエクスポート（JSON / CSV）をお願いします。",
			...
			"k27": "プラン別の猶予期間中（無料: 不可 / スタンダード: 7 日 / プレミアム: 30 日）であれば、ご家族の見守り画面から解約申請を取り消して有料プランを継続できます。",
			...
			"k58": "はい。ご家族の見守り画面の「プラン・お支払い」→「プラン変更・支払い管理」からお手続きいただけます。",
			...
			"k66": "はい。<strong>スタンダードプラン以上</strong>で、ご家族の見守り画面から JSON / CSV 形式でデータをエクスポートできます。",

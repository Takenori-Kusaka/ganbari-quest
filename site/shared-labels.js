...
(function () {
	...
	const LP_LABELS = {
		...
		"coreloop": {
			...
			"l1Badge": "活動",
			"l1Title": "毎日の活動を記録",
			"l1Desc": "「はみがきした」「宿題おわった」を 2 タップで記録。学年別に用意された候補から、家庭で必要なものを選んで設定できます。",
			"l2Badge": "習慣",
			"l2Title": "習慣カードで続ける",
		...
		"growthRoadmap": {
			...
			"sectionDesc": "お子さまの成長に合わせて UI と機能が変化。最後は「アプリを使わなくても自分で計画できる」子育てステージへ。",
			"linkLabel": "3 歳から 18 歳までの成長ストーリーを見る →",
			"pageTitle": "成長ロードマップ - がんばりクエスト",
			"pageHeroTitle": "3 歳から 18 歳まで、そして「卒業」へ",
			"pageHeroLead": "お子さまの成長に合わせて UI と機能が変化。最後は「アプリを使わなくても自分で計画できる」子育てステージへ。",
			"pageMetaDescription": "がんばりクエストの成長ロードマップ。幼児（3-5歳）から高校生（16-18歳）、そして「卒業」まで、お子さまの成長に合わせて UI と機能が変化していく様子を実画面付きで紹介。",
			"breadcrumbHome": "ホーム",
		...
		"faq": {
			...
			"text49": "プレミアムプラン",
			"text50": "無制限",
			"text51": "きょうだいランキング機能（プレミアムプラン）では、年齢差を考慮した調整もできるため「上の子が有利すぎる」状況を緩和できます。",
			...
			"text116": "基本的な活動記録はオフラインでも動作します（PWA のキャッシュ機能）。ただしデータ同期・新規お申し込み・決済などはオンライン接続が必要です。",
		...
		"faqB": {
			...
			"k51": "きょうだいランキング機能（プレミアムプラン）では、年齢差を考慮した調整もできるため「上の子が有利すぎる」状況を緩和できます。",
			"k52": "支払い方法は何が使えますか？",
			...
			"k114": "オフラインでも使えますか？",
			"k115": "基本的な活動記録はオフラインでも動作します（PWA のキャッシュ機能）。ただしデータ同期・新規お申し込み・決済などはオンライン接続が必要です。",

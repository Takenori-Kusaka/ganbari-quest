...
(function () {
	...
	const LP_LABELS = {
		...
		"coreloop": {
			...
			"parentPerspectiveDesc": "活動候補から選んで初期設定するだけで、子供の取り組みをポイントで定量把握できます。",
			"childPerspectiveTitle": "子供の視点",
			"childPerspectiveDesc": "活動を重ねてポイントを貯め、ごほうびショップで欲しいものと交換できます。",
			"l1Title": "毎日の活動 — がんばりを記録する",
			"l1Desc": "「はみがきした」「宿題おわった」を 2 タップで記録するだけで、ポイントが積み上がります。活動は学年別の候補から親が選んでセットアップ（初回 5 分）。日々の声かけを「タップ 1 回」に置き換えられます。",
			"l1Step1Title": "活動を 2 タップで記録",
			"l1Step1Desc": "「はみがきした」「宿題おわった」をタップするだけ。学年別の活動候補から親があらかじめ選んでおいた項目を、子供がタップする運用です。",
			"l1Step2Title": "ポイントが獲得できる",
			"l1Step2Desc": "記録した活動に応じてポイントが加算。「今日どれだけ頑張ったか」が数字で見えます。",
			"l2Title": "習慣カード — 毎日の楽しみで続ける",
			"l2Desc": "1 日 1 回までのおみくじスタンプ。レア度に応じてボーナスポイントが付き、毎日記録する習慣が自然に身につきます（煽らない設計）。1 週間続けるとスタンプカードが 1 枚完成し、三日坊主を防ぐ「継続の見える化」になります。",
			...
			"l3Desc": "貯まったポイントはごほうびショップが唯一の出口。実物のプレゼント・お小遣い・特権（夜ふかし権など）を親が設定し、子供が自分で選んで交換します。「あと 50 ポイントで欲しいごほうび」と、子供自身が計画を立てるようになります。",
			...
			"summaryNote": "活動 → 習慣 → ごほうび の 3 つの仕組みが循環することで、毎日のがんばりが本物の報酬として戻ってきます。",

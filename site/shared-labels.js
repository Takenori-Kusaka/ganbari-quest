...
(function () {
	...
	const LP_LABELS = {
		"retention": {
			...
			"sectionDesc": "「有料アプリって三日坊主になりがち…」という不安に先回りで答えます。レア度分散と毎日 1 回のおみくじスタンプが、子供の「明日もやろう」を支えます。",
			...
			"card3Desc": "毎日 1 回引けるおみくじスタンプは「もっと引きたい」と煽る連続演出を持ちません。明日もう 1 回というリズムが、自然な継続を生みます。",
			"pamphletNote": "スタンプカードのレア度分散（N/R/SR/UR）と毎日 1 回のおみくじスタンプが「明日もやろう」を支える習慣形成のエンジン。連続演出を持たない静かな仕組みで、三日坊主を防ぎます。"
		},
		"coreloop": {
			"sectionTitle": "3 つの仕組みで、毎日のがんばりが本物の報酬になる",
			"sectionDesc": "毎日「歯みがいた？」「宿題は？」と繰り返し声をかけるのは、親も子も疲れます。活動 → 習慣 → ごほうびの 3 つの仕組みで、子供が自分から動きだす毎日へ。",
			"summaryImageAlt": "活動 → 習慣 → ごほうび の循環図 — D3 勇者キャラクターを中心に 3 要素が円環で結ばれる",
			"summaryCaption": "活動を記録 → ポイントが貯まる → ごほうびと交換。子供が自分で計画する力を、3 つの仕組みで支えます。",
			"l1Badge": "活動",
			"l1Title": "毎日の活動を記録",
			"l1Desc": "「はみがきした」「宿題おわった」をタップだけで記録。学年別に用意された候補から、家庭で必要なものを選んで設定できます。",
			"l2Badge": "習慣",
			"l2Title": "習慣カードで続ける",
			"l2Desc": "毎日 1 回引けるおみくじスタンプで、子供が「明日もやろう」と自分から続けたくなります。",
			"l3Badge": "ごほうび",
			"l3Title": "ごほうびショップで交換",
			"l3Desc": "貯めたポイントはごほうびショップが唯一の出口。実物のプレゼント・お小遣い・特権を親が設定し、子供が自分で選んで交換できます。",
		...
		"common": {
			...
			"trialPeriodShort": "7 日間無料トライアル",
			"trialPeriodFull": "7 日間の無料トライアル",
			"ageRange": "3〜18 歳",
			"ageRangeLong": "3 歳から 18 歳まで",
			"yenSymbol": "¥",
			"pointUnitFull": "ポイント",
			"pointUnit": "pt",
		...
		"legalDisclaimer": {
			"cancelDisclaimer": "※解約後も現在の請求期間の終了日までご利用いただけます（日割り返金はありません）。解約でデータは削除されず、無料プランへ移行します。90 日を超えた記録は削除され、復元できません（再契約でも戻りません）。データを完全に消すのはアカウント退会のお手続きです。",
			"cancelDisclaimerLinks": "FAQ / 特定商取引法に基づく表記",
			"liabilityTitle": "サービス利用に関する重要なご案内",
			"liabilityBody": "本サービスは個人開発のため、利用規約にて賠償上限を定めております。詳しくは利用規約・FAQ をご確認ください。",
		...
		"versus": {
			...
			"sectionDesc": "多くのご家庭がまず紙で試して、続かずに諦めています。「3 歳から 18 歳まで」「家族みんなで」「ずっと続ける」を叶えるのが、がんばりクエストです。",
			"tagAnalog": "シール帳・紙",
			"tagDigital": "がんばりクエスト",
			"row1AnalogTitle": "お手伝いの種類が増えたり貼る場所がなくなっちゃう",
			"row1DigitalTitle": "自由に子供の活動をカスタマイズ",
			"row1DigitalDesc": "お子さまのフェーズに合わせた活動を予めご用意",
		...
		"growthRoadmap": {
			...
			"sectionDesc": "お子さまの成長に合わせて画面の見た目と情報量が変化。最後は「アプリを使わなくても自分で計画できる」子育てステージへ。",
			"linkLabel": "3 歳から 18 歳までの成長ストーリーを見る →",
			"pageTitle": "成長ロードマップ - がんばりクエスト",
			"pageHeroTitle": "3 歳から 18 歳まで、そして「卒業」へ",
			"pageHeroLead": "お子さまの成長に合わせて画面の見た目と情報量が変化。最後は「アプリを使わなくても自分で計画できる」子育てステージへ。",
			"pageMetaDescription": "がんばりクエストの成長ロードマップ。幼児（3-5歳）から高校生（16-18歳）、そして「卒業」まで、お子さまの成長に合わせて画面の見た目と情報量が変化していく様子を実画面付きで紹介。",
			"breadcrumbHome": "ホーム",
			...
			"elementaryDesc": "漢字 UI に切替、ウィークリーチャレンジで「次は何をやろう？」と自分で目標を立てる力が育ちます。",
			...
			"juniorDesc": "月次レポートで「自分のペース」を客観視し、自分で計画するリズム調整が可能に。",
			...
			"seniorDesc": "15 年分の活動ログが「自分はこれだけやってきた」という自信に（プレミアムの無期限保持でのご利用時）。",
			"seniorParentBenefit": "進路面談で活動履歴を語れる",
			"seniorChildExperience": "15年の履歴が自信になる",
			"graduateLabel": "そして",
			"graduateAccent": "卒業",
			"graduateTitle": "アプリを開かなくなった日 — それは家族の卒業式",
			"graduateDesc": "「使わなくなる」ことががんばりクエストの成功。記録はいつでも書き出してご家族の手元に残せます（書き出しは有料プラン、15 年分の保持はプレミアムの機能です）。",
		...
		"pricing": {
			...
			"metaDescription": "がんばりクエストの料金プラン。基本無料で始められます。スタンダード月額500円（税込）、プレミアム月額780円（税込）。すべての有料プランに7日間の無料体験付き。",
			"ogTitle": "料金プラン - がんばりクエスト",
			"ogDescription": "基本無料で始められます。お子さまのポイント・レベルアップ・毎日のごほうび（おみくじ + スタンプカード）などの冒険体験は無料プランでも一切制限ありません。",
			"heroTitle": "料金プラン",
			...
			"heroPriceBand": "基本無料 ・ 月 ¥500（税込）から ・ 有料は 7 日間無料体験 ・ いつでも解約できます（契約期間の縛りなし）",
			...
			"planFamilyName": "プレミアム",
			"planFamilyPrice": "¥780",
			"planFamilyUnit": "/月（税込）",
			"planFamilyPersona": "祖父母・離れた家族と一緒に応援したいご家族へ",
			"planFamilyDesc": "家族みんなで見守る。きょうだいの比較やレポートで成長を応援できます。",
			"planFamilyCta": "7日間 無料体験",
			"allPlansNote": "💡 お子さまが楽しめる冒険の仕組み（レベル・おみくじ・スタンプカード・毎日のごほうび・続けるごほうびなど）は",
			"allPlansNoteStrong": "全プラン共通",
			"allPlansNoteSuffix": "で制限なし",
			"comparisonTitle": "機能比較表",
			"comparisonSubtitle": "冒険の仕組みは全プラン共通で制限なく楽しめます",
			"trialHeading": "7 日間無料トライアル",
			"trialSubheading": "7 日間無料トライアル期間中は、すべての有料機能を制限なくお試しいただけます",
			"trialStep1Title": "いつでも好きなタイミングで開始",
			"trialStep1Desc": "アカウント登録後、ご家族の見守り画面からワンタップで無料体験を開始できます。クレジットカードの登録は不要です。",
			"trialStep2Title": "7日間、選択したプランの全機能が使い放題",
			"trialStep2Desc": "スタンダード/プレミアムいずれもプランの全機能（カスタム活動・レポート・データエクスポート・AI 自動提案・きょうだいランキング・離れた家族応援メッセージなど）を制限なくお試しいただけます。",
			"trialStep3Title": "終了後は自動で無料プランに戻ります",
			"trialStep3Desc": "無料体験期間が終わると、自動的に無料プランへ移行します。勝手にお金がかかることは一切ありません。",
			...
			"trialDataReassureLine1Suffix": "は、無料プランに移行した後も削除されません。上限を超える分は一時的に非表示（アーカイブ）になり、有料プランにアップグレードすると自動で元に戻ります。",
			"trialDataReassureLine2Strong": "活動履歴・ポイント獲得履歴・毎日のごほうび履歴",
			"trialDataReassureLine2Suffix": "は無料プランの保持期間（90 日）を超えたものから順次削除されます。",
			"trialDataReassureLine3": "有料プランにアップグレードすれば、より長期間（スタンダード: 1 年 / プレミアム: 無制限）の履歴をご利用いただけます。",
			...
			"familyPatternInviteDesc": "家族グループを作成し、招待リンクで家族を招待。家族メンバーがそれぞれの端末からアクセスでき、離れた場所からもお子さまの成長を見守れます。スタンダードはご家族4人まで（オーナーを含むため招待は3人まで）、プレミアムは無制限で招待できます。",
			"faqHeading": "よくあるご質問",
			"faqFreeQ": "無料プランでも十分使えますか？",
			"faqFreeA": "はい。プリセットの活動とチェックリストで基本的な機能はすべてお使いいただけます。お子さまの冒険体験（レベル、ポイント、おみくじ、スタンプカード、毎日のごほうび）は無料プランでも一切制限ありません。ただしごほうびショップへの商品登録（貯めたポイントと交換する商品の登録）はスタンダードプラン以上の機能です。",
			"faqAfterTrialQ": "無料体験後はどうなりますか？",
			"faqAfterTrialA": "7日間の無料体験終了後は無料プランに移行します。有料プランをご希望の場合は、ご家族の見守り画面からアップグレードしてください。クレジットカードの事前登録は不要です。無料体験中に作成したオリジナル活動・ごほうび・チェックリスト・シール・レベルは保持されますが、活動履歴・ポイント獲得履歴・毎日のごほうび履歴は無料プランの保持期間（90 日）を超えたものから順次削除されます。",
			"faqCancelQ": "解約したらデータはすぐに削除されますか？",
			"faqCancelA": "いいえ。解約してもデータは削除されません。現在の請求期間の終了日までは有料プランをそのままご利用いただけ、その後は無料プランへ自動的に切り替わります（お子さまの記録は残ります）。無料プランの履歴保持期間は 90 日です。90 日を超えた記録は削除され、復元できません（再契約でも戻りません）。必要な記録は、有料プランのご利用期間中に書き出してください。記録の書き出し（エクスポート）はスタンダードプラン以上の機能です。無料プランでは、退会のお手続きの画面からお子さまの名前と活動のまとめのみ保存できます。データそのものを消すのはアカウント退会のお手続きです。",
			"heroCancelDisclaimer": "※「いつでも解約できます（契約期間の縛りなし）」について: 解約後も現在の請求期間の終了日まではご利用いただけます（日割り返金はありません）。解約でデータは削除されず、無料プランへ移行します。90 日を超えた記録は削除され、復元できません（再契約でも戻りません）。データを完全に消すのはアカウント退会のお手続きです。",
			"faqBillingDateQ": "お支払い日はいつですか？",
			"faqBillingDateA": "お申し込み日を起算日として毎月自動更新されます。例えば4月15日にお申し込みの場合、次回のお支払い日は5月15日です。",
			"faqPaymentQ": "支払い方法は？",
			"faqPaymentA": "クレジットカード（Stripe が対応する主要ブランド）に対応しています。Stripeによる安全な決済処理を使用しており、カード情報は当サービスのサーバーには保存されません。",
			"faqPlanChangeQ": "プランの変更はできますか？",
			"faqPlanChangeA": "はい。スタンダード↔プレミアムの切り替えが可能です。ご家族の見守り画面の「プラン・お支払い」からお手続きいただけます。プラン変更方法についてご不明な点は、お問い合わせください。",
			"faqAdsQ": "子供の画面に広告は出ますか？",
			"faqAdsA": "いいえ。無料プランでも広告は一切表示しません。お子さまが安心して使える環境を最優先にしています。",
			"faqMultiDeviceQ": "家族で複数端末から使えますか？",
			"faqMultiDeviceA": "はい。スタンダード以上のプランで、家族メンバーを招待して複数端末からアクセスできます。スタンダードプランはご家族4人まで（オーナーを含むため招待は3人まで）、プレミアムプランは無制限に招待可能です。無料プランでも1つの端末でお子さまを切り替えて使えます。",
			...
			"trialCtaNote": "※ クレジットカード登録不要（7 日間の無料体験経路）。無料体験はご家族につき 1 回かぎりです",
			"faqCancelPathNote": "解約経路: ログイン後 [プラン・お支払い] → [請求管理ページを開く] (Stripe の請求管理ページ) でいつでもお手続きいただけます。",
			"faqCancelVsDeleteQ": "解約とアカウント退会は何が違いますか？",
			"faqCancelVsDeleteA": "解約は有料プランの自動更新を停止する手続きで、現在の請求期間の終了日に無料プランへ自動移行します。データは削除されず、無料プランの保持期間（90 日）を超えた記録だけが削除され、復元できません（再契約でも戻りません）。アカウント退会は、ログイン後にご自身で実施いただくことで、プラン別の猶予期間（無料プラン: 即時削除 / スタンダードプラン: 7 日間 / プレミアムプラン: 30 日間）の経過後に全データを完全削除します。",
		...
		"faq": {
			...
			"text9": "5. 技術的なご質問",
			"text10": "トライアル・解約について",
			"text11": "7 日間無料トライアルと、いつでも解約できる仕組みについて。",
			"text12": "無料トライアルの申込にクレジットカードは必要ですか？",
			"text13": "いいえ、不要です。",
			"text14": "トライアル期間終了時は自動で無料プランに戻ります。課金への切り替えは必ずご家族の見守り画面からお客さまご自身の操作で行っていただきます。",
			"text15": "トライアル後は自動で課金されますか？",
			"text16": "自動課金はされません。",
			"text17": "有料プランを継続したい場合のみ、ご家族の見守り画面の「プラン・お支払い」から明示的にアップグレードしてください。クレジットカード情報の入力はアップグレード操作の中で初めて求められます。",
			"text18": "途中で解約するとどうなりますか？",
			"text19": "解約してもデータは削除されません。現在の請求期間の終了日までは有料プランをそのままご利用いただけ（日割り計算による返金はありません）、その後は無料プランへ自動的に切り替わります。",
			"text20": "お子さまの記録はそのまま残り、無料プランの範囲で記録・ポイント付与を続けられます。",
			"text21": "無料プランの履歴保持期間は 90 日です。90 日を超えた記録は削除され、復元できません（再契約でも戻りません）。",
			"text22": "必要な記録がある場合は、有料プランのご利用期間中にご家族の見守り画面から書き出してください。記録の書き出し（エクスポート）はスタンダードプラン以上の機能です。無料プランでは、退会のお手続きの画面からお子さまの名前と活動のまとめのみ保存できます。",
			"text23": "トライアル中に作ったデータは残りますか？",
			"text24": "はい、残ります。",
			"text25": "ただし無料プランの制限（お子さま 2 人まで、活動 3 個までなど）を超える分は一時的に非表示（アーカイブ）になります。削除はされず、保護者の管理画面で非表示中のお子さまを確認できますが、記録・編集はできません。有料プランにアップグレードすると自動で元に戻ります。",
			"text26": "解約後に再開することはできますか？",
			"text27": "解約のお手続き後、現在の請求期間の終了日までは有料プランをそのままご利用いただけます。その間はいつでもご家族の見守り画面から解約を取り消して継続できます。",
			"text28": "ただし無料プランの保持期間（90 日）を超えて削除された記録は、再契約しても復元できません。",
			"text29": "料金・課金について",
			"text30": "3 つのプラン（フリー / スタンダード / プレミアム）と、課金の仕組みについて。",
			...
			"text49": "プレミアムプラン",
			"text50": "無制限",
			"text51": "きょうだいランキング機能（プレミアムプラン）は「今週どれだけがんばったか」を並べるものです。ポイント・レベルはお子さまごとに独立しているため、順位が下でも積み上げた記録が減ることはありません。",
			...
			"text55": "途中解約された場合も、お支払い済みの残り期間は引き続きご利用いただけます（プレミアム機能は期間満了まで有効）。",
			"text56": "特定商取引法に基づく表記",
			"text57": "プランの変更（スタンダード↔プレミアム）はできますか？",
			"text58": "はい。ご家族の見守り画面の「プラン・お支払い」からお手続きいただけます。",
			...
			"text76": "ご家族の見守り画面から退会（アカウント削除）を申請できます。猶予期間はご利用プランによって異なります（無料プラン: 即時削除 / スタンダードプラン: 7 日間 / プレミアムプラン: 30 日間）。",
			"text77": "無料プランは申請と同時に削除されるため、取り消しもエクスポートもできません。有料プランは猶予期間中に申請の取り消しとデータのエクスポートができます。猶予期間の経過後、全データは完全に削除されます（復旧はできません）。",
			...
			"text88": "中学生（13-15 歳）",
			"text89": "高校生（16-18 歳）",
			"text90": "お子さまが成長したら、ご家族の見守り画面から年齢モードを切り替えるだけで UI が自動で変わります。",
			...
			"text104": "15 分つづけて使うと自動でお子さま選択画面に戻る使いすぎ防止タイマーで、長時間の滞在を防止 (1 分操作がなければ計測はリセット)",
			"text105": "「スクリーンタイムを奪うのではなく、リアルの行動を促す」動機付けツールとしてお使いください。",
			"text106": "祖父母や親戚も使えますか？",
			"text107": "プレミアムプラン",
			"text108": "無制限",
			"text109": "招待されたメンバーは保護者として、お子さまの記録の確認と活動の記録ができます（アカウントを持たずに記録を見せたい場合は、プレミアムプランの閲覧リンクをお使いください。閲覧専用です）。",
			"text110": "技術的なご質問",
			...
			"text116": "記録には通信が必要です。オフラインでも、直前に開いた画面の表示はキャッシュから復元されますが、<strong>記録の保存はできません</strong>（電波が戻ってからお試しください）。新規お申し込み・決済も通信が必要です。",
			"text117": "旅行中や電波の弱い場所では記録の保存ができません。電波の届く場所に戻ってから記録してください。",
			...
			"text124": "初回のご返信は48時間以内（営業日ベース）を目標としています。",
			"text125": "無料で始める",
			"text126": "デモを見る",
		...
		"selfhost": {
			...
			"text17": "おすすめ環境",
			"text18": "&#x2705; セルフホスト版のメリット",
			"text19": " 記録は完全にご自身の管理下。AI 機能を使わない限り、データが外部へ送信されることはありません。",
			"text20": " 完全無料。月額料金なし、機能制限なし。",
			"text21": " カスタマイズ自由。ソースコードを自由に改変できます。",
			"text22": " オフライン利用可能。インターネット接続なしでも LAN 内で動作します。",
			"text23": " オープンソース（AGPL-3.0-only）。商用利用も可能です。",
			"licenseObligationNote": "守っていただく義務: 改変版をネットワーク経由で提供する場合は、同じライセンスでソースコードを開示する義務があります（AGPL-3.0-only のコピーレフト条項）。",
			"text24": "&#x1F4CA; SaaS版との比較",
			"text25": "項目",
			"text26": "SaaS版",
			"text27": "セルフホスト版",
		...
		"indexExtra": {
			...
			"k81": "保護者専用のカギ付き",
			"k82": "ご家族の見守り画面は保護者だけが開けるカギ（おやカギコード）でロックできます。お子さまが自分でポイントを増やしたり設定を変えたりすることができません。",
			"k83": "広告ゼロ・データは家族の手元に",
			...
			"k105": "7 日間無料・クレジットカード登録不要 / いつでも解約可能。",
		...
		"floatingCta": {
			...
			"midText": "3 つの仕組みは 1 分で体験できます<small>お申し込み前に動きを確認</small>",
		...
		"pamphlet": {
			...
			"k13": "活動",
			"k14": " 毎日の活動 &#x2192; ポイント",
			"k15": "「はみがきした」「宿題おわった」をタップするだけ。あらかじめ用意された 120 種類以上の活動がそのまま使えるので設定は最小限。記録のたびにポイントが積み上がります。",
			"k16": "習慣",
			"k17": " おみくじスタンプ &#x2192; 習慣",
			...
			"k44": "子供の登録：無制限",
			"k45": "オリジナル活動：無制限",
			"k46": "家族メンバー招待：3人まで（オーナーを含めご家族4人）",
			"k47": "ごほうびショップへの商品登録",
			"k48": "データのダウンロード",
			"k49": "1年間の履歴保持",
			"k50": "メールサポート",
			...
			"k72": "&#x2753; よくあるご質問",
			"k73": "料金はかかりますか？",
			"k74": "基本機能は無料でずっとお使いいただけます。有料プランはより多くのお子さまの登録や高度な分析機能が必要な場合にご検討ください。スタンダード・プレミアムプランは 7 日間無料トライアル付きです。",
			"k75": "何歳から使えますか？",
			...
			"k80": "ご家族の見守り画面の「プラン・お支払い」からアップグレードしていただくと、その場で有料機能が有効になります。クレジットカード（Visa / Mastercard / JCB / American Express）に対応し、Stripe による安全な決済処理を使用しています。詳しくは ",
			"k81": "料金プラン",
			"k82": " をご覧ください。",
			"k83": "&#x2694;&#xFE0F; がんばりクエスト",
		...
		"pricingExtra": {
			...
			"k11": "オリジナル活動の作成：無制限",
			"k12": "チェックリスト自由作成（無制限）",
			"k13": "家族メンバー招待：3人まで（オーナーを含めご家族4人）",
			"k14": "ごほうびショップへの商品登録",
		...
		"indexB": {
			...
			"kinderCheck3": "120+ プリセット活動からタップで選ぶだけ",
			...
			"k39": "成長の記録（成長レポート）",
			"k40": "成長レポートで、うんどう・べんきょうなど 5 つの軸のバランスをレーダーでひと目で把握。同年齢の平均と重ねて見られます。",
			"softMonthlyReportImgAlt": "成長レポート画面 — 5 つの軸のレーダーと同年齢の平均",
			"k41": "使いすぎ防止タイマー",
			"k42": "15 分つづけて使うと自動でお子さま選択画面に戻ります。時間の設定は不要です。",
			"k43": "おうえんメッセージ",
			...
			"k47": "まずは無料、必要なら月 ¥500〜",
			"k48": "家族みんなで基本無料で使えます。家族構成や使い方に合わせて、必要なら月 ¥500〜の有料プランも選べます。安心して始められる 4 つのお約束。",
			...
			"k65": "保護者専用のカギ付き",
			"k66": "ご家族の見守り画面は保護者だけが開けるカギ（おやカギコード）でロックできます。お子さまが自分でポイントを増やしたり設定を変えたりすることができません。",
			"k66Link": "FAQ で詳しく見る &#8594;",
			"k67": "データを家族の手元に",
			...
			"tourBenefitBattle": "<strong>家庭で起きること</strong>: 1 日の努力が「バトルで使えるエネルギー」として可視化される",
			"softBenefitMonthlyReport": "<strong>家庭で楽になること</strong>: よく取り組んでいる分野と手つかずの分野が一目でわかる",
			"softBenefitAutoSleep": "<strong>家庭で楽になること</strong>: 15 分つづけて使うと自動で戻り、長時間利用が起きない",
			...
			"softFamilySupportDesc": "ご家庭のリズムに合わせて、ステータス（うんどう・べんきょうなど 5 つの軸）が時間とともに少しずつ減る強さを調整できます。「毎日少しずつでも続けるとお得」な仕組みで、習慣化を後押しします。",
			...
			"pwaAndroidSteps": "画面右上の「⋮」→「ホーム画面に追加」→「追加」",
			"pwaIosTitle": "iPhone / iPad（Safari）",
			"pwaIosSteps": "画面下の「共有」（□に↑）→「ホーム画面に追加」→「追加」",
			"pwaNote": "アプリストアからのダウンロードは不要です。あとからアプリの「設定」→「サポート」でも手順を確認できます。"
		},
		"pricingB": {
			"k1": "お子さまの登録：2人まで",
			"k2": "プリセット活動の利用",
			...
			"k7": "90日間の履歴保持",
			"k8": "メールサポート（標準）",
			"k8b": "ごほうびショップへの商品登録はスタンダード以上",
			"k9": "お子さまの登録人数：無制限",
			"k10": "オリジナル活動の作成：無制限",
			"k11": "チェックリスト自由作成（無制限）",
			"k12": "家族メンバー招待：3人まで（オーナーを含めご家族4人）",
			"k13": "ごほうびショップへの商品登録",
			...
			"k39": "<td>ごほうびショップへの商品登録</td><td class=\"dash\">&#8212;</td><td class=\"check\">&#10003;</td><td class=\"check\">&#10003;</td>",
			"k40": "<td>AI 自動提案（活動・ごほうび・チェックリスト）</td><td class=\"dash\">&#8212;</td><td class=\"dash\">&#8212;</td><td class=\"check\">&#10003;</td>",
			"k41": "<td colspan=\"4\">レポート・家族機能</td>",
			"k42": "<td>本日の使用時間・今週の使用時間</td><td class=\"check\">&#10003;</td><td class=\"check\">&#10003;</td><td class=\"check\">&#10003;</td>",
			"k43": "<td>家族メンバー招待（別端末からアクセス）</td><td class=\"dash\">&#8212;</td><td>3人まで（オーナー含め4人）</td><td class=\"check\">無制限</td>",
		...
		"faqB": {
			...
			"k11": "7 日間無料トライアルと、いつでも解約できる仕組みについて。",
			"k12": "無料トライアルの申込にクレジットカードは必要ですか？",
			"k13": "<strong>いいえ、不要です。</strong>メールアドレスと Google アカウント（またはメール認証）でお申し込みするだけで、クレジットカード情報を入力せずに 7 日間すべての有料機能をお試しいただけます。",
			"k14": "トライアル期間終了時は自動で無料プランに戻ります。課金への切り替えは必ずご家族の見守り画面からお客さまご自身の操作で行っていただきます。",
			"k15": "トライアル後は自動で課金されますか？",
			"k16": "<strong>自動課金はされません。</strong>7 日間のトライアル終了時は、自動的に無料プランへ戻ります。",
			"k17": "有料プランを継続したい場合のみ、ご家族の見守り画面の「プラン・お支払い」から明示的にアップグレードしてください。クレジットカード情報の入力はアップグレード操作の中で初めて求められます。",
			"k18": "途中で解約するとどうなりますか？",
			"k19": "ご家族の見守り画面の「プラン・お支払い」→「請求管理ページを開く」（Stripe の請求管理ページ）からいつでも解約できます。解約しても<strong>データは削除されません</strong>。現在の請求期間の終了日までは有料プランをそのままご利用いただけ（日割り計算による返金はありません）、その後は無料プランへ自動的に切り替わります。",
			"k20": "お子さまの記録はそのまま残り、無料プランの範囲で記録・ポイント付与を続けられます。",
			"k21": "無料プランの履歴保持期間は 90 日です。90 日を超えた記録は削除され、復元できません（再契約でも戻りません）。",
			"k22": "必要な記録がある場合は、有料プランのご利用期間中にご家族の見守り画面から書き出してください。記録の書き出し（エクスポート）はスタンダードプラン以上の機能です。無料プランでは、退会のお手続きの画面からお子さまの名前と活動のまとめのみ保存できます。",
			"k23": "トライアル中に作ったデータは残りますか？",
			"k24": "<strong>はい、残ります。</strong>トライアル終了後に無料プランへ戻っても、お子さま・活動・ポイント・履歴などのデータは引き続き保存されます。",
			"k25": "ただし無料プランの制限（お子さま 2 人まで、活動 3 個までなど）を超える分は一時的に非表示（アーカイブ）になります。削除はされず、保護者の管理画面で非表示中のお子さまを確認できますが、記録・編集はできません。有料プランにアップグレードすると自動で元に戻ります。",
			"k26": "解約後に再開することはできますか？",
			"k27": "解約のお手続き後、現在の請求期間の終了日までは有料プランをそのままご利用いただけます。その間はいつでもご家族の見守り画面から解約を取り消して継続できます。",
			"k28": "ただし無料プランの保持期間（90 日）を超えて削除された記録は、再契約しても復元できません。",
			"k29": "<span class=\"faq-category-num\">2</span>料金・課金について",
			"k30": "3 つのプラン（フリー / スタンダード / プレミアム）と、課金の仕組みについて。",
			"k31": "無料プランと有料プランは何が違いますか？",
			"k32": "お子さまの冒険体験（活動記録・ポイント・レベル・スタンプ・チャレンジ・続けるごほうび）は、<strong>無料プランでもすべてご利用いただけます</strong>。",
			"k33": "有料プランで解放される主な機能:",
			"k34": "お子さま・活動の人数制限解除（フリー: お子さま 2 人 / 活動 3 個まで）",
			"k35": "長期の履歴保持（フリー: 過去 90 日まで / スタンダード: 1 年 / プレミアム: 無期限）",
			"k36": "AI 自動提案（活動案・ごほうび案）※プレミアムのみ",
			"k37": "きょうだいランキング ※プレミアムのみ / 家族メンバー招待",
			"k38": "データのバックアップ",
			...
			"k49": "<strong>スタンダードプラン</strong>: お子さま無制限で登録可能・ご家族は<strong>合計4 人まで</strong>（オーナーを含むため、招待できるのは3 人まで。核家族でのご利用想定）",
			"k50": "<strong>プレミアムプラン</strong>: お子さま無制限で登録可能・家族メンバー招待は <strong>無制限</strong>（祖父母・おじおばなど拡張家族でのご利用想定）",
			"k51": "きょうだいランキング機能（プレミアムプラン）は「今週どれだけがんばったか」を並べるものです。ポイント・レベルはお子さまごとに独立しているため、順位が下でも積み上げた記録が減ることはありません。",
			"k52": "支払い方法は何が使えますか？",
			...
			"k57": "プランの変更（スタンダード↔プレミアム）はできますか？",
			"k58": "はい。ご家族の見守り画面の「プラン・お支払い」からお手続きいただけます。",
			...
			"k66": "はい。<strong>スタンダードプラン以上</strong>で、ご家族の見守り画面から家族のデータをバックアップファイルとしてエクスポートできます。",
			...
			"k76": "ご家族の見守り画面から退会（アカウント削除）を申請できます。猶予期間はご利用プランによって異なります（無料プラン: 即時削除 / スタンダードプラン: 7 日間 / プレミアムプラン: 30 日間）。",
			"k77": "無料プランは申請と同時に削除されるため、取り消しもエクスポートもできません。有料プランは猶予期間中に申請の取り消しとデータのエクスポートができます。猶予期間の経過後、全データは完全に削除されます（復旧はできません）。",
			...
			"k90": "お子さまが成長したら、ご家族の見守り画面から年齢モードを切り替えるだけで UI が自動で変わります。",
			...
			"k96": "<strong>初日</strong>: お申し込み → お子さま登録 → 年齢に応じた、あらかじめ用意された活動を選ぶ（12 セット・120 種類以上の中から）",
			"k97": "<strong>毎日</strong>: お子さまが自分で活動を記録 → 保護者はご家族の見守り画面で結果を確認（所要時間 30 秒〜）",
			...
			"k104": "15 分つづけて使うと自動でお子さま選択画面に戻る使いすぎ防止タイマーで、長時間の滞在を防止 (1 分操作がなければ計測はリセット)",
			"k105": "「スクリーンタイムを奪うのではなく、リアルの行動を促す」動機付けツールとしてお使いください。",
			"k106": "祖父母や親戚も使えますか？",
			"k107": "<strong>プレミアムプラン</strong>では、保護者側のメンバーを<strong>無制限</strong>に招待できます。祖父母・おじおば・離れて暮らす親御さまなどが、同じお子さまの成長を見守れます（スタンダードプランはご家族合計4 人まで＝オーナーを含むため招待は3 人までです）。",
			"k108": "招待されたメンバーは保護者として、お子さまの記録の確認と活動の記録ができます（アカウントを持たずに記録を見せたい場合は、プレミアムプランの閲覧リンクをお使いください。閲覧専用です）。",
			...
			"k114": "オフラインでも使えますか？",
			"k115": "記録には通信が必要です。オフラインでも、直前に開いた画面の表示はキャッシュから復元されますが、<strong>記録の保存はできません</strong>（電波が戻ってからお試しください）。新規お申し込み・決済も通信が必要です。",
			...
			"k120": "ほかにご質問はありますか？",
			"k121": "上記にないご質問や、ご要望・フィードバックは、メールでお気軽にお寄せください。初回のご返信は48時間以内（営業日ベース）を目標としています。",
			"k122": "無料で始める",
			"k123": "デモを見る",
			"k124": "無料プランの上限を超えるお子さま・活動・チェックリストは保管された状態になり、有料プランに戻すと元どおりご利用いただけます"
		},
		"pamphletB": {
			"k1": "がんばりクエスト パンフレット",
			"k2": "&#x1F5A8; 印刷 / PDF保存",
			...
			"k13": "「はみがきした」「宿題おわった」をタップするだけ。あらかじめ用意された 120 種類以上の活動がそのまま使えるので設定は最小限。記録のたびにポイントが積み上がります。",
			...
			"k65": "&#x2753; よくあるご質問",
			"k66": "料金はかかりますか？",
			"k67": "基本機能は無料でずっとお使いいただけます。有料プランはより多くのお子さまの登録や高度な分析機能が必要な場合にご検討ください。スタンダード・プレミアムプランは 7 日間無料トライアル付きです。",
			"k68": "何歳から使えますか？",
			...
			"k73": "ご家族の見守り画面の「プラン・お支払い」からアップグレードしていただくと、その場で有料機能が有効になります。クレジットカード（Visa / Mastercard / JCB / American Express）に対応し、Stripe による安全な決済処理を使用しています。詳しくは <a href=\"https://www.ganbari-quest.com/pricing.html\">料金プラン</a> をご覧ください。",
			"k74": "&#x2694;&#xFE0F; がんばりクエスト",
		...
		"legalPrivacy": {
			...
			"section6": "<h2>第6条（データの削除）</h2><ol><li><strong>個別データの削除</strong>: 特定の活動記録やお子さまの情報の削除は、本サービスのご家族の見守り画面から即時実行できます。</li><li><strong>アカウント全体の削除</strong>: アカウント削除を申請後、ご利用プランに応じた猶予期間を設けます（無料プラン: 即時削除 / スタンダードプラン: 7日間 / プレミアムプラン: 30日間）。猶予期間中は削除の取消しが可能です。</li><li><strong>バックアップからの完全消去</strong>: アカウント削除後90日以内に、バックアップデータからも完全に消去されます。</li></ol>",
		...
		"legalTerms": {
			...
			"section7": "<h2>第7条（料金および支払い）</h2><ol><li>本サービスの基本機能は無料でご利用いただけます。一部の機能は有料プランへの加入が必要です。料金の詳細は本サービス内の料金ページに記載します。</li><li>有料プランの支払いは、運営者が指定する決済サービスを通じて行われます。</li><li>有料プランは契約期間ごとに自動更新されます。自動更新の停止（解約）は、次回更新日の前日までにご家族の見守り画面の「プラン・お支払い」→「請求管理ページを開く」（Stripe の請求管理ページ）から行うことができます。</li><li>解約後も、支払い済み期間の終了日まで有料プランの機能をご利用いただけます。</li><li>日割り計算による返金は行いません。</li><li><strong>解約とアカウント削除の違い</strong>: 解約はサブスクリプションの自動更新停止のみを行うものであり、利用者のデータは無料プランへ移行して保持されます（保持期間は次項に定めます）。データを完全に削除したい場合は、本サービスにログインのうえ、設定画面の「アカウント削除」から本人が実施してください。詳細は第13条に定めます。</li><li><strong>プラン別の履歴保持期間</strong>: 活動記録等の履歴は、ご利用中のプランに応じて次の期間保持されます。無料プラン: 90日間 / スタンダードプラン: 1年間 / プレミアムプラン: 無期限。保持期間を超えた履歴は削除され、復元できません（再度有料プランにご加入いただいた場合も戻りません）。</li><li><strong>プラン変更</strong>: 利用者はいつでもプランを変更できます。上位プランへの変更（アップグレード）は直ちに反映されます。下位プランへの変更（ダウングレード）および解約による無料プランへの移行では、<strong>変更後のプランの保持期間を超える履歴は削除されます</strong>。また、変更後のプランの上限を超えるお子さま・活動等は閲覧できない状態になります。プラン変更のお手続きをご自身で行う場合、削除される履歴があるときは手続きの前に画面上でお知らせします。解約により無料プランへ移行する場合は、解約時点でこの案内は行われません。</li></ol>",
			"section8": "<h2>第8条（無料トライアル）</h2><ol><li>有料プランには無料トライアル期間が含まれる場合があります。期間の詳細は本サービス内に記載します。</li><li>無料トライアルのご利用にお支払い情報の登録は不要です。期間中・終了後を問わず、自動的に料金が発生することはありません。</li><li>無料トライアル期間終了後、自動的に無料プランに移行します。有料プランへの移行はお客さまご自身でご家族の見守り画面より手続きしていただく必要があります。</li><li>無料トライアルは、<strong>ご家族（家族グループ）につき1回</strong>のみご利用いただけます。同一のご家族に属する複数のアカウントで重ねてご利用いただくことはできません。ただし、運営者が実施するキャンペーン等により、運営者の判断で再度ご提供する場合があります。</li></ol>",
		...
		"legalSla": {
			...
			"section3": "<h2>第3条（デプロイおよび計画メンテナンス）</h2><ol><li>本サービスは継続的デプロイ（CI/CD）を採用しており、通常のコードデプロイはゼロダウンタイムで実施されます。通常のデプロイにおいてサービスの中断は発生しません。</li><li>インフラストラクチャの変更（CDKスタック更新、データベースマイグレーション等）により、サービスの一時的な中断が見込まれる場合は「計画メンテナンス」として扱い、以下の対応を行います。<ul><li>事前通知: 24時間前までに本サービス内のお知らせにて告知します。あわせて、影響が大きいと運営者が判断した場合は登録メールアドレスへ順次ご連絡します</li><li>影響範囲および想定される中断時間の事前説明</li></ul></li><li>緊急のセキュリティパッチ等、事前通知なく実施する場合があります。この場合は可能な限り速やかに通知します。</li></ol>",
			...
			"section5": "<h2>第5条（障害通知）</h2><ol><li>サービス障害が発生した場合、運営者は本サービス内のお知らせにて状況を通知します。重大な障害の際は、登録メールアドレスへご連絡する場合があります。</li><li>障害の検知はデプロイ時の自動検証および定期的なヘルスチェック（準備中）により行われ、異常を検知した場合は速やかに対応を開始し通知します。</li></ol>",

...
# Ready for Review 化前のローカル一括セルフチェック (Issue #1775)
# biome / svelte-check / vitest / hardcoded-strings / lp-dimensions / check-pr-body / capture を順次実行
npm run pre-ready -- --pr <num>   # PR 作成済み: 全 7 Step 検証
npm run pre-ready                 # PR 未作成: Step 6/7 (PR body / capture) は skip
```
